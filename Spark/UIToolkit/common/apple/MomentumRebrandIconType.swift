...
@objc public enum MomentumRebrandIconType: Int {
    ...
    public var ligature: String {
        ...
        case .genericDeviceVideoSmallFilled: return "\u{f48f}"
        case .gifBold: return "\u{f490}"
        case .gifFilled: return "\u{f491}"
        case .gifLight: return "\u{f492}"
        case .gifRegular: return "\u{f493}"
        case .guestIssuerBold: return "\u{f494}"
        case .guestIssuerLight: return "\u{f495}"
        case .guestIssuerRegular: return "\u{f496}"
        case .guideBold: return "\u{f497}"
        case .guideLight: return "\u{f498}"
        case .guideRegular: return "\u{f499}"
        case .handlerBold: return "\u{f49a}"
        case .handlerLight: return "\u{f49b}"
        case .handlerRegular: return "\u{f49c}"
        case .handsetAlertBold: return "\u{f49d}"
        case .handsetAlertFilled: return "\u{f49e}"
        case .handsetAlertLight: return "\u{f49f}"
        case .handsetAlertRegular: return "\u{f4a0}"
        case .handsetBold: return "\u{f4a1}"
        case .handsetFilled: return "\u{f4a2}"
        case .handsetLight: return "\u{f4a3}"
        case .handsetMutedBold: return "\u{f4a4}"
        case .handsetMutedFilled: return "\u{f4a5}"
        case .handsetMutedLight: return "\u{f4a6}"
        case .handsetMutedRegular: return "\u{f4a7}"
        case .handsetRegular: return "\u{f4a8}"
        case .handshakeBold: return "\u{f4a9}"
        case .handshakeLight: return "\u{f4aa}"
        case .handshakeRegular: return "\u{f4ab}"
        case .headingOneBold: return "\u{f4ac}"
        case .headingOneLight: return "\u{f4ad}"
        case .headingOneRegular: return "\u{f4ae}"
        case .headingThreeBold: return "\u{f4af}"
        case .headingThreeLight: return "\u{f4b0}"
        case .headingThreeRegular: return "\u{f4b1}"
        case .headingTwoBold: return "\u{f4b2}"
        case .headingTwoLight: return "\u{f4b3}"
        case .headingTwoRegular: return "\u{f4b4}"
        case .headsetAlertBold: return "\u{f4b5}"
        case .headsetAlertLight: return "\u{f4b6}"
        case .headsetAlertRegular: return "\u{f4b7}"
        case .headsetBold: return "\u{f4b8}"
        case .headsetFilled: return "\u{f4b9}"
        case .headsetLight: return "\u{f4ba}"
        case .headsetMutedBold: return "\u{f4bb}"
        case .headsetMutedLight: return "\u{f4bc}"
        case .headsetMutedRegular: return "\u{f4bd}"
        case .headsetPrivateBold: return "\u{f4be}"
        case .headsetPrivateLight: return "\u{f4bf}"
        case .headsetPrivateRegular: return "\u{f4c0}"
        case .headsetRegular: return "\u{f4c1}"
        case .helpBold: return "\u{f4c2}"
        case .helpCircleActiveFilled: return "\u{f4c3}"
        case .helpCircleBold: return "\u{f4c4}"
        case .helpCircleLight: return "\u{f4c5}"
        case .helpCircleRegular: return "\u{f4c6}"
        case .helpLight: return "\u{f4c7}"
        case .helpRegular: return "\u{f4c8}"
        case .helpdeskBold: return "\u{f4c9}"
        case .helpdeskLight: return "\u{f4ca}"
        case .helpdeskRegular: return "\u{f4cb}"
        case .hideBold: return "\u{f4cc}"
        case .hideFilled: return "\u{f4cd}"
        case .hideLight: return "\u{f4ce}"
        case .hideRegular: return "\u{f4cf}"
        case .homeBold: return "\u{f4d0}"
        case .homeFilled: return "\u{f4d1}"
        case .homeLight: return "\u{f4d2}"
        case .homeRegular: return "\u{f4d3}"
        case .horizontalLineBold: return "\u{f4d4}"
        case .horizontalLineLight: return "\u{f4d5}"
        case .horizontalLineRegular: return "\u{f4d6}"
        case .humidityBold: return "\u{f4d7}"
        case .humidityLight: return "\u{f4d8}"
        case .humidityRegular: return "\u{f4d9}"
        case .huntGroupBold: return "\u{f4da}"
        case .huntGroupFilled: return "\u{f4db}"
        case .huntGroupLight: return "\u{f4dc}"
        case .huntGroupRegular: return "\u{f4dd}"
        case .importBold: return "\u{f4de}"
        case .importLight: return "\u{f4df}"
        case .importRegular: return "\u{f4e0}"
        case .incomingCallLegacyBold: return "\u{f4e1}"
        case .incomingCallLegacyLight: return "\u{f4e2}"
        case .incomingCallLegacyRegular: return "\u{f4e3}"
        case .infoBadgeFilled: return "\u{f4e4}"
        case .infoCircleBold: return "\u{f4e5}"
        case .infoCircleFilled: return "\u{f4e6}"
        case .infoCircleLight: return "\u{f4e7}"
        case .infoCircleRegular: return "\u{f4e8}"
        case .infoCircleTwoBold: return "\u{f4e9}"
        case .infoCircleTwoFilled: return "\u{f4ea}"
        case .infoCircleTwoLight: return "\u{f4eb}"
        case .infoCircleTwoRegular: return "\u{f4ec}"
        case .inputBold: return "\u{f4ed}"
        case .inputDisconnectedBold: return "\u{f4ee}"
        case .inputDisconnectedLight: return "\u{f4ef}"
        case .inputDisconnectedRegular: return "\u{f4f0}"
        case .inputLight: return "\u{f4f1}"
        case .inputRegular: return "\u{f4f2}"
        case .integrationsBold: return "\u{f4f3}"
        case .integrationsLight: return "\u{f4f4}"
        case .integrationsRegular: return "\u{f4f5}"
        case .invitedUserBold: return "\u{f4f6}"
        case .invitedUserLight: return "\u{f4f7}"
        case .invitedUserRegular: return "\u{f4f8}"
        case .italicBold: return "\u{f4f9}"
        case .italicLight: return "\u{f4fa}"
        case .italicRegular: return "\u{f4fb}"
        case .joinAudioBold: return "\u{f4fc}"
        case .joinAudioFilled: return "\u{f4fd}"
        case .joinAudioLight: return "\u{f4fe}"
        case .joinAudioRegular: return "\u{f4ff}"
        case .keyboardBold: return "\u{f500}"
        case .keyboardCloseBold: return "\u{f501}"
        case .keyboardCloseLight: return "\u{f502}"
        case .keyboardCloseRegular: return "\u{f503}"
        case .keyboardLight: return "\u{f504}"
        case .keyboardRegular: return "\u{f505}"
        case .languageBold: return "\u{f506}"
        case .languageLight: return "\u{f507}"
        case .languageRegular: return "\u{f508}"
        case .laptopBold: return "\u{f509}"
        case .laptopDisconnectedBold: return "\u{f50a}"
        case .laptopDisconnectedLight: return "\u{f50b}"
        case .laptopDisconnectedRegular: return "\u{f50c}"
        case .laptopFilled: return "\u{f50d}"
        case .laptopLight: return "\u{f50e}"
        case .laptopRegular: return "\u{f50f}"
        case .laserPointerBold: return "\u{f510}"
        case .laserPointerLight: return "\u{f511}"
        case .laserPointerRegular: return "\u{f512}"
        case .launchBold: return "\u{f513}"
        case .launchLight: return "\u{f514}"
        case .launchRegular: return "\u{f515}"
        case .layoutSideBySideVerticalBold: return "\u{f516}"
        case .layoutSideBySideVerticalFilled: return "\u{f517}"
        case .layoutSideBySideVerticalLight: return "\u{f518}"
        case .layoutSideBySideVerticalRegular: return "\u{f519}"
        case .leaveDeviceBold: return "\u{f51a}"
        case .leaveDeviceLight: return "\u{f51b}"
        case .leaveDeviceRegular: return "\u{f51c}"
        case .likeBold: return "\u{f51d}"
        case .likeFilled: return "\u{f51e}"
        case .likeLight: return "\u{f51f}"
        case .likeRegular: return "\u{f520}"
        case .linkBold: return "\u{f521}"
        case .linkLight: return "\u{f522}"
        case .linkRegular: return "\u{f523}"
        case .listBulletedBold: return "\u{f524}"
        case .listBulletedLight: return "\u{f525}"
        case .listBulletedRegular: return "\u{f526}"
        case .listMenuBold: return "\u{f527}"
        case .listMenuLight: return "\u{f528}"
        case .listMenuRegular: return "\u{f529}"
        case .listNumberedBold: return "\u{f52a}"
        case .listNumberedLight: return "\u{f52b}"
        case .listNumberedRegular: return "\u{f52c}"
        case .locationBold: return "\u{f52d}"
        case .locationFilled: return "\u{f52e}"
        case .locationLight: return "\u{f52f}"
        case .locationRegular: return "\u{f530}"
        case .lowerHandBold: return "\u{f531}"
        case .lowerHandLight: return "\u{f532}"
        case .lowerHandRegular: return "\u{f533}"
        case .markAsUnreadBold: return "\u{f534}"
        case .markAsUnreadLight: return "\u{f535}"
        case .markAsUnreadRegular: return "\u{f536}"
        case .markdownBold: return "\u{f537}"
        case .markdownLight: return "\u{f538}"
        case .markdownRegular: return "\u{f539}"
        case .markerBold: return "\u{f53a}"
        case .markerFilled: return "\u{f53b}"
        case .markerLight: return "\u{f53c}"
        case .markerRegular: return "\u{f53d}"
        case .maximizeBold: return "\u{f53e}"
        case .maximizeLight: return "\u{f53f}"
        case .maximizeRegular: return "\u{f540}"
        case .mediaPlayerBold: return "\u{f541}"
        case .mediaPlayerLight: return "\u{f542}"
        case .mediaPlayerRegular: return "\u{f543}"
        case .mediaQualityGoodBold: return "\u{f544}"
        case .mediaQualityGoodFilled: return "\u{f545}"
        case .mediaQualityGoodLight: return "\u{f546}"
        case .mediaQualityGoodRegular: return "\u{f547}"
        case .mediaQualityPoorBold: return "\u{f548}"
        case .mediaQualityPoorFilled: return "\u{f549}"
        case .mediaQualityPoorLight: return "\u{f54a}"
        case .mediaQualityPoorRegular: return "\u{f54b}"
        case .mediaQualityUnstableBold: return "\u{f54c}"
        case .mediaQualityUnstableFilled: return "\u{f54d}"
        case .mediaQualityUnstableLight: return "\u{f54e}"
        case .mediaQualityUnstableRegular: return "\u{f54f}"
        case .meetBold: return "\u{f550}"
        case .meetEndBold: return "\u{f551}"
        case .meetEndLight: return "\u{f552}"
        case .meetEndRegular: return "\u{f553}"
        case .meetFilled: return "\u{f554}"
        case .meetLight: return "\u{f555}"
        case .meetRegular: return "\u{f556}"
        case .meetingsBold: return "\u{f557}"
        case .meetingsFilled: return "\u{f558}"
        case .meetingsFocusMonthBold: return "\u{f559}"
        case .meetingsFocusMonthLight: return "\u{f55a}"
        case .meetingsFocusMonthRegular: return "\u{f55b}"
        case .meetingsFocusOneDayBold: return "\u{f55c}"
        case .meetingsFocusOneDayLight: return "\u{f55d}"
        case .meetingsFocusOneDayRegular: return "\u{f55e}"
        case .meetingsFocusThreeDayBold: return "\u{f55f}"
        case .meetingsFocusThreeDayLight: return "\u{f560}"
        case .meetingsFocusThreeDayRegular: return "\u{f561}"
        case .meetingsFocusUpcomingBold: return "\u{f562}"
        case .meetingsFocusUpcomingLight: return "\u{f563}"
        case .meetingsFocusUpcomingRegular: return "\u{f564}"
        case .meetingsFocusWeekBold: return "\u{f565}"
        case .meetingsFocusWeekLight: return "\u{f566}"
        case .meetingsFocusWeekRegular: return "\u{f567}"
        case .meetingsLight: return "\u{f568}"
        case .meetingsPresenceBold: return "\u{f569}"
        case .meetingsPresenceFilled: return "\u{f56a}"
        case .meetingsPresenceLight: return "\u{f56b}"
        case .meetingsPresenceRegular: return "\u{f56c}"
        case .meetingsPresenceSmallFilled: return "\u{f56d}"
        case .meetingsRegular: return "\u{f56e}"
        case .meetingsTeamActiveBold: return "\u{f56f}"
        case .meetingsTeamActiveLight: return "\u{f570}"
        case .meetingsTeamActiveRegular: return "\u{f571}"
        case .meetingsTeamBold: return "\u{f572}"
        case .meetingsTeamLight: return "\u{f573}"
        case .meetingsTeamNewBold: return "\u{f574}"
        case .meetingsTeamNewLight: return "\u{f575}"
        case .meetingsTeamNewRegular: return "\u{f576}"
        case .meetingsTeamRegular: return "\u{f577}"
        case .mentionBold: return "\u{f578}"
        case .mentionLight: return "\u{f579}"
        case .mentionRegular: return "\u{f57a}"
        case .microphoneBold: return "\u{f57b}"
        case .microphoneFilled: return "\u{f57c}"
        case .microphoneHardMutedBold: return "\u{f57d}"
        case .microphoneHardMutedColoredBold: return "\u{f57e}"
        case .microphoneHardMutedColoredLight: return "\u{f57f}"
        case .microphoneHardMutedColoredRegular: return "\u{f580}"
        case .microphoneHardMutedLight: return "\u{f581}"
        case .microphoneHardMutedRegular: return "\u{f582}"
        case .microphoneLight: return "\u{f583}"
        case .microphoneMusicModeColoredBold: return "\u{f584}"
        case .microphoneMusicModeColoredLight: return "\u{f585}"
        case .microphoneMusicModeColoredRegular: return "\u{f586}"
        case .microphoneMutedBold: return "\u{f587}"
        case .microphoneMutedFilled: return "\u{f588}"
        case .microphoneMutedIndicatorFilled: return "\u{f589}"
        case .microphoneMutedLight: return "\u{f58a}"
        case .microphoneMutedRegular: return "\u{f58b}"
        case .microphoneRegular: return "\u{f58c}"
        case .minimizeBold: return "\u{f58d}"
        case .minimizeLight: return "\u{f58e}"
        case .minimizeRegular: return "\u{f58f}"
        case .minusBold: return "\u{f590}"
        case .minusLight: return "\u{f591}"
        case .minusRegular: return "\u{f592}"
        case .mirrorBold: return "\u{f593}"
        case .mirrorFilled: return "\u{f594}"
        case .mirrorLight: return "\u{f595}"
        case .mirrorRegular: return "\u{f596}"
        case .moreAdrBold: return "\u{f597}"
        case .moreAdrLight: return "\u{f598}"
        case .moreAdrRegular: return "\u{f599}"
        case .moreBold: return "\u{f59a}"
        case .moreCircleBold: return "\u{f59b}"
        case .moreCircleFilled: return "\u{f59c}"
        case .moreCircleLight: return "\u{f59d}"
        case .moreCircleRegular: return "\u{f59e}"
        case .moreLight: return "\u{f59f}"
        case .moreRegular: return "\u{f5a0}"
        case .mouseCursorBold: return "\u{f5a1}"
        case .mouseCursorLight: return "\u{f5a2}"
        case .mouseCursorRegular: return "\u{f5a3}"
        case .moveCallInAdrBold: return "\u{f5a4}"
        case .moveCallInAdrLight: return "\u{f5a5}"
        case .moveCallInAdrRegular: return "\u{f5a6}"
        case .moveCallInIphBold: return "\u{f5a7}"
        case .moveCallInIphLight: return "\u{f5a8}"
        case .moveCallInIphRegular: return "\u{f5a9}"
        case .moveCallInLaptopBold: return "\u{f5aa}"
        case .moveCallInLaptopLight: return "\u{f5ab}"
        case .moveCallInLaptopRegular: return "\u{f5ac}"
        case .moveCallInOutAdrBold: return "\u{f5ad}"
        case .moveCallInOutAdrLight: return "\u{f5ae}"
        case .moveCallInOutAdrRegular: return "\u{f5af}"
        case .moveCallInOutIphBold: return "\u{f5b0}"
        case .moveCallInOutIphLight: return "\u{f5b1}"
        case .moveCallInOutIphRegular: return "\u{f5b2}"
        case .moveCallInTabletBold: return "\u{f5b3}"
        case .moveCallInTabletLight: return "\u{f5b4}"
        case .moveCallInTabletRegular: return "\u{f5b5}"
        case .moveCallOutAdrBold: return "\u{f5b6}"
        case .moveCallOutAdrLight: return "\u{f5b7}"
        case .moveCallOutAdrRegular: return "\u{f5b8}"
        case .moveCallOutIphBold: return "\u{f5b9}"
        case .moveCallOutIphLight: return "\u{f5ba}"
        case .moveCallOutIphRegular: return "\u{f5bb}"
        case .moveCallOutLaptopBold: return "\u{f5bc}"
        case .moveCallOutLaptopLight: return "\u{f5bd}"
        case .moveCallOutLaptopRegular: return "\u{f5be}"
        case .moveCallOutTabletBold: return "\u{f5bf}"
        case .moveCallOutTabletLight: return "\u{f5c0}"
        case .moveCallOutTabletRegular: return "\u{f5c1}"
        case .multilineChartBold: return "\u{f5c2}"
        case .multilineChartFilled: return "\u{f5c3}"
        case .multilineChartLight: return "\u{f5c4}"
        case .multilineChartRegular: return "\u{f5c5}"
        case .multimediaBold: return "\u{f5c6}"
        case .multimediaLight: return "\u{f5c7}"
        case .multimediaRegular: return "\u{f5c8}"
        case .multipledDevicesBold: return "\u{f5c9}"
        case .multipledDevicesLight: return "\u{f5ca}"
        case .multipledDevicesRegular: return "\u{f5cb}"
        case .musicModeBold: return "\u{f5cc}"
        case .musicModeCircleBold: return "\u{f5cd}"
        case .musicModeCircleFilled: return "\u{f5ce}"
        case .musicModeCircleLight: return "\u{f5cf}"
        case .musicModeCircleRegular: return "\u{f5d0}"
        case .musicModeFilled: return "\u{f5d1}"
        case .musicModeLight: return "\u{f5d2}"
        case .musicModeRegular: return "\u{f5d3}"
        case .muteOnEntryBold: return "\u{f5d4}"
        case .muteOnEntryFilled: return "\u{f5d5}"
        case .muteOnEntryLight: return "\u{f5d6}"
        case .muteOnEntryRegular: return "\u{f5d7}"
        case .newVoicemailBold: return "\u{f5d8}"
        case .newVoicemailLight: return "\u{f5d9}"
        case .newVoicemailRegular: return "\u{f5da}"
        case .newWhiteboardBold: return "\u{f5db}"
        case .newWhiteboardLight: return "\u{f5dc}"
        case .newWhiteboardRegular: return "\u{f5dd}"
        case .nextBold: return "\u{f5de}"
        case .nextLight: return "\u{f5df}"
        case .nextRegular: return "\u{f5e0}"
        case .noDevicesBold: return "\u{f5e1}"
        case .noDevicesLight: return "\u{f5e2}"
        case .noDevicesRegular: return "\u{f5e3}"
        case .noiseRemovalBold: return "\u{f5e4}"
        case .noiseRemovalLight: return "\u{f5e5}"
        case .noiseRemovalRegular: return "\u{f5e6}"
        case .noteBold: return "\u{f5e7}"
        case .noteLight: return "\u{f5e8}"
        case .notePptBold: return "\u{f5e9}"
        case .notePptLight: return "\u{f5ea}"
        case .notePptRegular: return "\u{f5eb}"
        case .noteRegular: return "\u{f5ec}"
        case .notesBold: return "\u{f5ed}"
        case .notesLight: return "\u{f5ee}"
        case .notesRegular: return "\u{f5ef}"
        case .numberBold: return "\u{f5f0}"
        case .numberLight: return "\u{f5f1}"
        case .numberRegular: return "\u{f5f2}"
        case .oldRemoteBold: return "\u{f5f3}"
        case .oldRemoteLight: return "\u{f5f4}"
        case .oldRemoteRegular: return "\u{f5f5}"
        case .oldTouchBold: return "\u{f5f6}"
        case .oldTouchLight: return "\u{f5f7}"
        case .oldTouchRegular: return "\u{f5f8}"
        case .openInFolderBold: return "\u{f5f9}"
        case .openInFolderLight: return "\u{f5fa}"
        case .openInFolderRegular: return "\u{f5fb}"
        case .openPagesBold: return "\u{f5fc}"
        case .openPagesLight: return "\u{f5fd}"
        case .openPagesRegular: return "\u{f5fe}"
        case .otherNumberBold: return "\u{f5ff}"
        case .otherNumberLight: return "\u{f600}"
        case .otherNumberRegular: return "\u{f601}"
        case .otherNumberWarningBold: return "\u{f602}"
        case .otherNumberWarningLight: return "\u{f603}"
        case .otherNumberWarningRegular: return "\u{f604}"
        case .outgoingCallLegacyBold: return "\u{f605}"
        case .outgoingCallLegacyLight: return "\u{f606}"
        case .outgoingCallLegacyRegular: return "\u{f607}"
        case .overflowLeftBold: return "\u{f608}"
        case .overflowLeftLight: return "\u{f609}"
        case .overflowLeftRegular: return "\u{f60a}"
        case .overflowRightBold: return "\u{f60b}"
        case .overflowRightLight: return "\u{f60c}"
        case .overflowRightRegular: return "\u{f60d}"
        case .pairedCameraBold: return "\u{f60e}"
        case .pairedCameraLight: return "\u{f60f}"
        case .pairedCameraRegular: return "\u{f610}"
        case .pairedDeviceBold: return "\u{f611}"
        case .pairedDeviceLight: return "\u{f612}"
        case .pairedDeviceRegular: return "\u{f613}"
        case .pairedHandsetBold: return "\u{f614}"
        case .pairedHandsetLight: return "\u{f615}"
        case .pairedHandsetRegular: return "\u{f616}"
        case .pairingBold: return "\u{f617}"
        case .pairingLight: return "\u{f618}"
        case .pairingRegular: return "\u{f619}"
        case .parkedBold: return "\u{f61a}"
        case .parkedFilled: return "\u{f61b}"
        case .parkedLight: return "\u{f61c}"
        case .parkedRegular: return "\u{f61d}"
        case .parseBold: return "\u{f61e}"
        case .parseLight: return "\u{f61f}"
        case .parseRegular: return "\u{f620}"
        case .participantAddBold: return "\u{f621}"
        case .participantAddLight: return "\u{f622}"
        case .participantAddRegular: return "\u{f623}"
        case .participantBlockedBold: return "\u{f624}"
        case .participantBlockedLight: return "\u{f625}"
        case .participantBlockedRegular: return "\u{f626}"
        case .participantBold: return "\u{f627}"
        case .participantFilled: return "\u{f628}"
        case .participantLight: return "\u{f629}"
        case .participantListBold: return "\u{f62a}"
        case .participantListFilled: return "\u{f62b}"
        case .participantListLight: return "\u{f62c}"
        case .participantListRegular: return "\u{f62d}"
        case .participantRegular: return "\u{f62e}"
        case .participantRemoveBold: return "\u{f62f}"
        case .participantRemoveLight: return "\u{f630}"
        case .participantRemoveRegular: return "\u{f631}"
        case .participantUnknownBold: return "\u{f632}"
        case .participantUnknownLight: return "\u{f633}"
        case .participantUnknownRegular: return "\u{f634}"
        case .passMouseBold: return "\u{f635}"
        case .passMouseLight: return "\u{f636}"
        case .passMouseRegular: return "\u{f637}"
        case .pauseBold: return "\u{f638}"
        case .pauseFilled: return "\u{f639}"
        case .pauseLight: return "\u{f63a}"
        case .pauseRegular: return "\u{f63b}"
        case .penBold: return "\u{f63c}"
        case .penFilled: return "\u{f63d}"
        case .penLight: return "\u{f63e}"
        case .penRegular: return "\u{f63f}"
        case .peopleBold: return "\u{f640}"
        case .peopleCircleBold: return "\u{f641}"
        case .peopleCircleFilled: return "\u{f642}"
        case .peopleCircleLight: return "\u{f643}"
        case .peopleCircleRegular: return "\u{f644}"
        case .peopleFilled: return "\u{f645}"
        case .peopleInsightsFilled: return "\u{f646}"
        case .peopleLight: return "\u{f647}"
        case .peopleRegular: return "\u{f648}"
        case .phoneAlertBold: return "\u{f649}"
        case .phoneAlertLight: return "\u{f64a}"
        case .phoneAlertRegular: return "\u{f64b}"
        case .phoneBold: return "\u{f64c}"
        case .phoneFilled: return "\u{f64d}"
        case .phoneLight: return "\u{f64e}"
        case .phoneMutedBold: return "\u{f64f}"
        case .phoneMutedLight: return "\u{f650}"
        case .phoneMutedRegular: return "\u{f651}"
        case .phonePrivateBold: return "\u{f652}"
        case .phonePrivateLight: return "\u{f653}"
        case .phonePrivateRegular: return "\u{f654}"
        case .phoneRegular: return "\u{f655}"
        case .phoneReplyAllBold: return "\u{f656}"
        case .phoneReplyAllLight: return "\u{f657}"
        case .phoneReplyAllRegular: return "\u{f658}"
        case .phoneReplyBold: return "\u{f659}"
        case .phoneReplyLight: return "\u{f65a}"
        case .phoneReplyRegular: return "\u{f65b}"
        case .phoneSmallFilled: return "\u{f65c}"
        case .pickerBold: return "\u{f65d}"
        case .pickerLight: return "\u{f65e}"
        case .pickerRegular: return "\u{f65f}"
        case .pictureInPictureBold: return "\u{f660}"
        case .pictureInPictureLight: return "\u{f661}"
        case .pictureInPictureRegular: return "\u{f662}"
        case .pieChartBold: return "\u{f663}"
        case .pieChartFilled: return "\u{f664}"
        case .pieChartLight: return "\u{f665}"
        case .pieChartRegular: return "\u{f666}"
        case .pinBold: return "\u{f667}"
        case .pinFilled: return "\u{f668}"
        case .pinLight: return "\u{f669}"
        case .pinListBold: return "\u{f66a}"
        case .pinListLight: return "\u{f66b}"
        case .pinListRegular: return "\u{f66c}"
        case .pinMutedBold: return "\u{f66d}"
        case .pinMutedLight: return "\u{f66e}"
        case .pinMutedRegular: return "\u{f66f}"
        case .pinRegular: return "\u{f670}"
        case .placeholderBold: return "\u{f671}"
        case .placeholderLight: return "\u{f672}"
        case .placeholderRegular: return "\u{f673}"
        case .playBold: return "\u{f674}"
        case .playFilled: return "\u{f675}"
        case .playLight: return "\u{f676}"
        case .playRegular: return "\u{f677}"
        case .plugAcBold: return "\u{f678}"
        case .plugAcLight: return "\u{f679}"
        case .plugAcRegular: return "\u{f67a}"
        case .plusBold: return "\u{f67b}"
        case .plusCircleBold: return "\u{f67c}"
        case .plusCircleFilled: return "\u{f67d}"
        case .plusCircleLight: return "\u{f67e}"
        case .plusCircleRegular: return "\u{f67f}"
        case .plusLight: return "\u{f680}"
        case .plusRegular: return "\u{f681}"
        case .pmrBold: return "\u{f682}"
        case .pmrFilled: return "\u{f683}"
        case .pmrLight: return "\u{f684}"
        case .pmrRegular: return "\u{f685}"
        case .pollBold: return "\u{f686}"
        case .pollLight: return "\u{f687}"
        case .pollRegular: return "\u{f688}"
        case .popInBold: return "\u{f689}"
        case .popInLight: return "\u{f68a}"
        case .popInRegular: return "\u{f68b}"
        case .popOutBold: return "\u{f68c}"
        case .popOutLight: return "\u{f68d}"
        case .popOutRegular: return "\u{f68e}"
        case .popUpBold: return "\u{f68f}"
        case .popUpLight: return "\u{f690}"
        case .popUpRegular: return "\u{f691}"
        case .portraitLandscapeBold: return "\u{f692}"
        case .portraitLandscapeLight: return "\u{f693}"
        case .portraitLandscapeRegular: return "\u{f694}"
        case .powerAcBold: return "\u{f695}"
        case .powerAcLight: return "\u{f696}"
        case .powerAcRegular: return "\u{f697}"
        case .powerBold: return "\u{f698}"
        case .powerLight: return "\u{f699}"
        case .powerRegular: return "\u{f69a}"
        case .presentationBold: return "\u{f69b}"
        case .presentationLight: return "\u{f69c}"
        case .presentationRegular: return "\u{f69d}"
        case .printBold: return "\u{f69e}"
        case .printLight: return "\u{f69f}"
        case .printRegular: return "\u{f6a0}"
        case .priorityBadgeFilled: return "\u{f6a1}"
        case .priorityCircleBold: return "\u{f6a2}"
        case .priorityCircleFilled: return "\u{f6a3}"
        case .priorityCircleLight: return "\u{f6a4}"
        case .priorityCircleRegular: return "\u{f6a5}"
        case .priorityCircleTwoBold: return "\u{f6a6}"
        case .priorityCircleTwoFilled: return "\u{f6a7}"
        case .priorityCircleTwoLight: return "\u{f6a8}"
        case .priorityCircleTwoRegular: return "\u{f6a9}"
        case .privacyCircleBold: return "\u{f6aa}"
        case .privacyCircleFilled: return "\u{f6ab}"
        case .privacyCircleLight: return "\u{f6ac}"
        case .privacyCircleRegular: return "\u{f6ad}"
        case .privateBold: return "\u{f6ae}"
        case .privateCircleBold: return "\u{f6af}"
        case .privateCircleFilled: return "\u{f6b0}"
        case .privateCircleLight: return "\u{f6b1}"
        case .privateCircleRegular: return "\u{f6b2}"
        case .privateLight: return "\u{f6b3}"
        case .privateMeetingBold: return "\u{f6b4}"
        case .privateMeetingLight: return "\u{f6b5}"
        case .privateMeetingRegular: return "\u{f6b6}"
        case .privateRegular: return "\u{f6b7}"
        case .productDemoBold: return "\u{f6b8}"
        case .productDemoLight: return "\u{f6b9}"
        case .productDemoRegular: return "\u{f6ba}"
        case .proximityBold: return "\u{f6bb}"
        case .proximityLight: return "\u{f6bc}"
        case .proximityMutedBold: return "\u{f6bd}"
        case .proximityMutedLight: return "\u{f6be}"
        case .proximityMutedRegular: return "\u{f6bf}"
        case .proximityRegular: return "\u{f6c0}"
        case .proximityVideoBold: return "\u{f6c1}"
        case .proximityVideoLight: return "\u{f6c2}"
        case .proximityVideoRegular: return "\u{f6c3}"
        case .ptoPresenceBold: return "\u{f6c4}"
        case .ptoPresenceFilled: return "\u{f6c5}"
        case .ptoPresenceLight: return "\u{f6c6}"
        case .ptoPresenceRegular: return "\u{f6c7}"
        case .pullCallBold: return "\u{f6c8}"
        case .pullCallLight: return "\u{f6c9}"
        case .pullCallRegular: return "\u{f6ca}"
        case .qABold: return "\u{f6cb}"
        case .qALight: return "\u{f6cc}"
        case .qARegular: return "\u{f6cd}"
        case .qualityBold: return "\u{f6ce}"
        case .qualityLight: return "\u{f6cf}"
        case .qualityRegular: return "\u{f6d0}"
        case .queueContactBold: return "\u{f6d1}"
        case .queueContactLight: return "\u{f6d2}"
        case .queueContactRegular: return "\u{f6d3}"
        case .quietBold: return "\u{f6d4}"
        case .quietHoursPresenceBold: return "\u{f6d5}"
        case .quietHoursPresenceFilled: return "\u{f6d6}"
        case .quietHoursPresenceLight: return "\u{f6d7}"
        case .quietHoursPresenceRegular: return "\u{f6d8}"
        case .quietLight: return "\u{f6d9}"
        case .quietRegular: return "\u{f6da}"
        case .raiseHandBold: return "\u{f6db}"
        case .raiseHandLight: return "\u{f6dc}"
        case .raiseHandRegular: return "\u{f6dd}"
        case .ramBold: return "\u{f6de}"
        case .ramLight: return "\u{f6df}"
        case .ramRegular: return "\u{f6e0}"
        case .reactionsBold: return "\u{f6e1}"
        case .reactionsFilled: return "\u{f6e2}"
        case .reactionsLight: return "\u{f6e3}"
        case .reactionsRegular: return "\u{f6e4}"
        case .reactivateBold: return "\u{f6e5}"
        case .reactivateLight: return "\u{f6e6}"
        case .reactivateRegular: return "\u{f6e7}"
        case .recentsBold: return "\u{f6e8}"
        case .recentsFilled: return "\u{f6e9}"
        case .recentsLight: return "\u{f6ea}"
        case .recentsPresenceBold: return "\u{f6eb}"
        case .recentsPresenceFilled: return "\u{f6ec}"
        case .recentsPresenceLight: return "\u{f6ed}"
        case .recentsPresenceRegular: return "\u{f6ee}"
        case .recentsPresenceSmallFilled: return "\u{f6ef}"
        case .recentsRegular: return "\u{f6f0}"
        case .recordBold: return "\u{f6f1}"
        case .recordFilled: return "\u{f6f2}"
        case .recordLight: return "\u{f6f3}"
        case .recordPausedBold: return "\u{f6f4}"
        case .recordPausedFilled: return "\u{f6f5}"
        case .recordPausedLight: return "\u{f6f6}"
        case .recordPausedRegular: return "\u{f6f7}"
        case .recordRegular: return "\u{f6f8}"
        case .recurringBold: return "\u{f6f9}"
        case .recurringLight: return "\u{f6fa}"
        case .recurringOffBold: return "\u{f6fb}"
        case .recurringOffLight: return "\u{f6fc}"
        case .recurringOffRegular: return "\u{f6fd}"
        case .recurringRegular: return "\u{f6fe}"
        case .redialBold: return "\u{f6ff}"
        case .redialLight: return "\u{f700}"
        case .redialRegular: return "\u{f701}"
        case .redoBold: return "\u{f702}"
        case .redoLight: return "\u{f703}"
        case .redoRegular: return "\u{f704}"
        case .refreshBold: return "\u{f705}"
        case .refreshLight: return "\u{f706}"
        case .refreshRegular: return "\u{f707}"
        case .remoteDesktopControlBold: return "\u{f708}"
        case .remoteDesktopControlFilled: return "\u{f709}"
        case .remoteDesktopControlLight: return "\u{f70a}"
        case .remoteDesktopControlRegular: return "\u{f70b}"
        case .removeBold: return "\u{f70c}"
        case .removeFilled: return "\u{f70d}"
        case .removeLight: return "\u{f70e}"
        case .removeRegular: return "\u{f70f}"
        case .replyBold: return "\u{f710}"
        case .replyFilled: return "\u{f711}"
        case .replyLight: return "\u{f712}"
        case .replyListBold: return "\u{f713}"
        case .replyListLight: return "\u{f714}"
        case .replyListRegular: return "\u{f715}"
        case .replyRegular: return "\u{f716}"
        case .resetBold: return "\u{f717}"
        case .resetLight: return "\u{f718}"
        case .resetRegular: return "\u{f719}"
        case .responsiveMobileBold: return "\u{f71a}"
        case .responsiveMobileLight: return "\u{f71b}"
        case .responsiveMobileRegular: return "\u{f71c}"
        case .restartBold: return "\u{f71d}"
        case .restartLight: return "\u{f71e}"
        case .restartRegular: return "\u{f71f}"
        case .returnBold: return "\u{f720}"
        case .returnLight: return "\u{f721}"
        case .returnRegular: return "\u{f722}"
        case .ringtoneBold: return "\u{f723}"
        case .ringtoneLight: return "\u{f724}"
        case .ringtoneRegular: return "\u{f725}"
        case .roomCalendarBold: return "\u{f726}"
        case .roomCalendarLight: return "\u{f727}"
        case .roomCalendarRegular: return "\u{f728}"
        case .roomLightsBold: return "\u{f729}"
        case .roomLightsLight: return "\u{f72a}"
        case .roomLightsRegular: return "\u{f72b}"
        case .rotateContentBold: return "\u{f72c}"
        case .rotateContentFilled: return "\u{f72d}"
        case .rotateContentLight: return "\u{f72e}"
        case .rotateContentRegular: return "\u{f72f}"
        case .runningApplicationBold: return "\u{f730}"
        case .runningApplicationFilled: return "\u{f731}"
        case .runningApplicationLight: return "\u{f732}"
        case .runningApplicationRegular: return "\u{f733}"
        case .saveBold: return "\u{f734}"
        case .saveLight: return "\u{f735}"
        case .saveRegular: return "\u{f736}"
        case .scanBold: return "\u{f737}"
        case .scanLight: return "\u{f738}"
        case .scanRegular: return "\u{f739}"
        case .schedulerAvailableBold: return "\u{f73a}"
        case .schedulerAvailableLight: return "\u{f73b}"
        case .schedulerAvailableRegular: return "\u{f73c}"
        case .schedulerNotWorkingHoursBold: return "\u{f73d}"
        case .schedulerNotWorkingHoursLight: return "\u{f73e}"
        case .schedulerNotWorkingHoursRegular: return "\u{f73f}"
        case .schedulerUnavailableBold: return "\u{f740}"
        case .schedulerUnavailableLight: return "\u{f741}"
        case .schedulerUnavailableRegular: return "\u{f742}"
        case .schedulerUnknownBold: return "\u{f743}"
        case .schedulerUnknownLight: return "\u{f744}"
        case .schedulerUnknownRegular: return "\u{f745}"
        case .screenshotBold: return "\u{f746}"
        case .screenshotDocBold: return "\u{f747}"
        case .screenshotDocFilled: return "\u{f748}"
        case .screenshotDocLight: return "\u{f749}"
        case .screenshotDocRegular: return "\u{f74a}"
        case .screenshotLight: return "\u{f74b}"
        case .screenshotRegular: return "\u{f74c}"
        case .searchBold: return "\u{f74d}"
        case .searchLight: return "\u{f74e}"
        case .searchRegular: return "\u{f74f}"
        case .secondaryArrowBold: return "\u{f750}"
        case .secondaryArrowLight: return "\u{f751}"
        case .secondaryArrowRegular: return "\u{f752}"
        case .secureCallLockBold: return "\u{f753}"
        case .secureCallLockFilled: return "\u{f754}"
        case .secureCallLockLight: return "\u{f755}"
        case .secureCallLockRegular: return "\u{f756}"
        case .secureCallShieldBold: return "\u{f757}"
        case .secureCallShieldFilled: return "\u{f758}"
        case .secureCallShieldLight: return "\u{f759}"
        case .secureCallShieldRegular: return "\u{f75a}"
        case .secureCircleBold: return "\u{f75b}"
        case .secureCircleFilled: return "\u{f75c}"
        case .secureCircleLight: return "\u{f75d}"
        case .secureCircleRegular: return "\u{f75e}"
        case .secureLockBold: return "\u{f75f}"
        case .secureLockFilled: return "\u{f760}"
        case .secureLockLight: return "\u{f761}"
        case .secureLockRegular: return "\u{f762}"
        case .selectAllBold: return "\u{f763}"
        case .selectAllFilled: return "\u{f764}"
        case .selectAllLight: return "\u{f765}"
        case .selectAllRegular: return "\u{f766}"
        case .selectionBold: return "\u{f767}"
        case .selectionLight: return "\u{f768}"
        case .selectionRegular: return "\u{f769}"
        case .sendBold: return "\u{f76a}"
        case .sendFilled: return "\u{f76b}"
        case .sendLight: return "\u{f76c}"
        case .sendRegular: return "\u{f76d}"
        case .serverBold: return "\u{f76e}"
        case .serverErrorBold: return "\u{f76f}"
        case .serverErrorLight: return "\u{f770}"
        case .serverErrorRegular: return "\u{f771}"
        case .serverLight: return "\u{f772}"
        case .serverRegular: return "\u{f773}"
        case .servicesBold: return "\u{f774}"
        case .servicesLight: return "\u{f775}"
        case .servicesRegular: return "\u{f776}"
        case .setVariableBold: return "\u{f777}"
        case .setVariableLight: return "\u{f778}"
        case .setVariableRegular: return "\u{f779}"
        case .settingsBold: return "\u{f77a}"
        case .settingsFilled: return "\u{f77b}"
        case .settingsLight: return "\u{f77c}"
        case .settingsRegular: return "\u{f77d}"
        case .setupAssistantBold: return "\u{f77e}"
        case .setupAssistantLight: return "\u{f77f}"
        case .setupAssistantRegular: return "\u{f780}"
        case .shapeDiagonalLineBold: return "\u{f781}"
        case .shapeDiagonalLineLight: return "\u{f782}"
        case .shapeDiagonalLineRegular: return "\u{f783}"
        case .shapeOvalBold: return "\u{f784}"
        case .shapeOvalLight: return "\u{f785}"
        case .shapeOvalRegular: return "\u{f786}"
        case .shapesBold: return "\u{f787}"
        case .shapesLight: return "\u{f788}"
        case .shapesRegular: return "\u{f789}"
        case .shareCNativeAdrBold: return "\u{f78a}"
        case .shareCNativeAdrLight: return "\u{f78b}"
        case .shareCNativeAdrRegular: return "\u{f78c}"
        case .shareCNativeIphBold: return "\u{f78d}"
        case .shareCNativeIphLight: return "\u{f78e}"
        case .shareCNativeIphRegular: return "\u{f78f}"
        case .shareScreenBold: return "\u{f790}"
        case .shareScreenFilled: return "\u{f791}"
        case .shareScreenLight: return "\u{f792}"
        case .shareScreenRegular: return "\u{f793}"
        case .shareScreenSmallFilled: return "\u{f794}"
        case .shareSpaceBold: return "\u{f795}"
        case .shareSpaceLight: return "\u{f796}"
        case .shareSpaceRegular: return "\u{f797}"
        case .shieldBold: return "\u{f798}"
        case .shieldLight: return "\u{f799}"
        case .shieldRegular: return "\u{f79a}"
        case .showBold: return "\u{f79b}"
        case .showFilled: return "\u{f79c}"
        case .showLight: return "\u{f79d}"
        case .showRegular: return "\u{f79e}"
        case .signInBold: return "\u{f79f}"
        case .signInForcedBold: return "\u{f7a0}"
        case .signInForcedLight: return "\u{f7a1}"
        case .signInForcedRegular: return "\u{f7a2}"
        case .signInLight: return "\u{f7a3}"
        case .signInRegular: return "\u{f7a4}"
        case .signOutBold: return "\u{f7a5}"
        case .signOutLight: return "\u{f7a6}"
        case .signOutRegular: return "\u{f7a7}"
        case .signal0Bold: return "\u{f7a8}"
        case .signal0Light: return "\u{f7a9}"
        case .signal0Regular: return "\u{f7aa}"
        case .signal100Bold: return "\u{f7ab}"
        case .signal100Light: return "\u{f7ac}"
        case .signal100Regular: return "\u{f7ad}"
        case .signal25Bold: return "\u{f7ae}"
        case .signal25Light: return "\u{f7af}"
        case .signal25Regular: return "\u{f7b0}"
        case .signal50Bold: return "\u{f7b1}"
        case .signal50Light: return "\u{f7b2}"
        case .signal50Regular: return "\u{f7b3}"
        case .signal75Bold: return "\u{f7b4}"
        case .signal75Light: return "\u{f7b5}"
        case .signal75Regular: return "\u{f7b6}"
        case .singleNumberReachBold: return "\u{f7b7}"
        case .singleNumberReachLight: return "\u{f7b8}"
        case .singleNumberReachRegular: return "\u{f7b9}"
        case .sipRegistrationInProgressBold: return "\u{f7ba}"
        case .sipRegistrationInProgressFilled: return "\u{f7bb}"
        case .sipRegistrationInProgressLight: return "\u{f7bc}"
        case .sipRegistrationInProgressRegular: return "\u{f7bd}"
        case .skipBold: return "\u{f7be}"
        case .skipBwBold: return "\u{f7bf}"
        case .skipBwFilled: return "\u{f7c0}"
        case .skipBwLight: return "\u{f7c1}"
        case .skipBwRegular: return "\u{f7c2}"
        case .skipFwBold: return "\u{f7c3}"
        case .skipFwFilled: return "\u{f7c4}"
        case .skipFwLight: return "\u{f7c5}"
        case .skipFwRegular: return "\u{f7c6}"
        case .skipLight: return "\u{f7c7}"
        case .skipRegular: return "\u{f7c8}"
        case .speakerBold: return "\u{f7c9}"
        case .speakerDisconnectedBold: return "\u{f7ca}"
        case .speakerDisconnectedFilled: return "\u{f7cb}"
        case .speakerDisconnectedLight: return "\u{f7cc}"
        case .speakerDisconnectedRegular: return "\u{f7cd}"
        case .speakerFilled: return "\u{f7ce}"
        case .speakerLight: return "\u{f7cf}"
        case .speakerMutedBold: return "\u{f7d0}"
        case .speakerMutedFilled: return "\u{f7d1}"
        case .speakerMutedLight: return "\u{f7d2}"
        case .speakerMutedRegular: return "\u{f7d3}"
        case .speakerOffBold: return "\u{f7d4}"
        case .speakerOffFilled: return "\u{f7d5}"
        case .speakerOffLight: return "\u{f7d6}"
        case .speakerOffRegular: return "\u{f7d7}"
        case .speakerOnColoredBold: return "\u{f7d8}"
        case .speakerOnColoredLight: return "\u{f7d9}"
        case .speakerOnColoredRegular: return "\u{f7da}"
        case .speakerRegular: return "\u{f7db}"
        case .speakerTurnDownBold: return "\u{f7dc}"
        case .speakerTurnDownFilled: return "\u{f7dd}"
        case .speakerTurnDownLight: return "\u{f7de}"
        case .speakerTurnDownRegular: return "\u{f7df}"
        case .speakerTurnUpBold: return "\u{f7e0}"
        case .speakerTurnUpFilled: return "\u{f7e1}"
        case .speakerTurnUpLight: return "\u{f7e2}"
        case .speakerTurnUpRegular: return "\u{f7e3}"
        case .spinnerBold: return "\u{f7e4}"
        case .spinnerFilledBold: return "\u{f7e5}"
        case .spinnerFilledLight: return "\u{f7e6}"
        case .spinnerFilledRegular: return "\u{f7e7}"
        case .spinnerLight: return "\u{f7e8}"
        case .spinnerRegular: return "\u{f7e9}"
        case .stackedArea100ChartBold: return "\u{f7ea}"
        case .stackedArea100ChartFilled: return "\u{f7eb}"
        case .stackedArea100ChartLight: return "\u{f7ec}"
        case .stackedArea100ChartRegular: return "\u{f7ed}"
        case .stackedAreaChartBold: return "\u{f7ee}"
        case .stackedAreaChartFilled: return "\u{f7ef}"
        case .stackedAreaChartLight: return "\u{f7f0}"
        case .stackedAreaChartRegular: return "\u{f7f1}"
        case .stackedBar100ChartBold: return "\u{f7f2}"
        case .stackedBar100ChartFilled: return "\u{f7f3}"
        case .stackedBar100ChartLight: return "\u{f7f4}"
        case .stackedBar100ChartRegular: return "\u{f7f5}"
        case .stackedBarChartBold: return "\u{f7f6}"
        case .stackedBarChartFilled: return "\u{f7f7}"
        case .stackedBarChartLight: return "\u{f7f8}"
        case .stackedBarChartRegular: return "\u{f7f9}"
        case .startChatBold: return "\u{f7fa}"
        case .startChatLight: return "\u{f7fb}"
        case .startChatRegular: return "\u{f7fc}"
        case .stickersBold: return "\u{f7fd}"
        case .stickersLight: return "\u{f7fe}"
        case .stickersRegular: return "\u{f7ff}"
        case .stickiesBold: return "\u{f800}"
        case .stickiesLight: return "\u{f801}"
        case .stickiesRegular: return "\u{f802}"
        case .stopBold: return "\u{f803}"
        case .stopCircleBold: return "\u{f804}"
        case .stopCircleFilled: return "\u{f805}"
        case .stopCircleLight: return "\u{f806}"
        case .stopCircleRegular: return "\u{f807}"
        case .stopContentShareBold: return "\u{f808}"
        case .stopContentShareLight: return "\u{f809}"
        case .stopContentShareRegular: return "\u{f80a}"
        case .stopFilled: return "\u{f80b}"
        case .stopLight: return "\u{f80c}"
        case .stopRegular: return "\u{f80d}"
        case .storedInfoBold: return "\u{f80e}"
        case .storedInfoFilled: return "\u{f80f}"
        case .storedInfoLight: return "\u{f810}"
        case .storedInfoRegular: return "\u{f811}"
        case .streamingBold: return "\u{f812}"
        case .streamingLight: return "\u{f813}"
        case .streamingRegular: return "\u{f814}"
        case .strikethroughBold: return "\u{f815}"
        case .strikethroughLight: return "\u{f816}"
        case .strikethroughRegular: return "\u{f817}"
        case .subscriptBold: return "\u{f818}"
        case .subscriptLight: return "\u{f819}"
        case .subscriptRegular: return "\u{f81a}"
        case .superscriptBold: return "\u{f81b}"
        case .superscriptLight: return "\u{f81c}"
        case .superscriptRegular: return "\u{f81d}"
        case .sx10Bold: return "\u{f81e}"
        case .sx10Light: return "\u{f81f}"
        case .sx10Regular: return "\u{f820}"
        case .sx20Bold: return "\u{f821}"
        case .sx20Light: return "\u{f822}"
        case .sx20Regular: return "\u{f823}"
        case .sx80CodecBold: return "\u{f824}"
        case .sx80CodecLight: return "\u{f825}"
        case .sx80CodecRegular: return "\u{f826}"
        case .tableBold: return "\u{f827}"
        case .tableLight: return "\u{f828}"
        case .tableRegular: return "\u{f829}"
        case .tabletBold: return "\u{f82a}"
        case .tabletLight: return "\u{f82b}"
        case .tabletRegular: return "\u{f82c}"
        case .tabsBold: return "\u{f82d}"
        case .tabsLight: return "\u{f82e}"
        case .tabsRegular: return "\u{f82f}"
        case .tagBold: return "\u{f830}"
        case .tagLight: return "\u{f831}"
        case .tagRegular: return "\u{f832}"
        case .telepresenceAlertBold: return "\u{f833}"
        case .telepresenceAlertLight: return "\u{f834}"
        case .telepresenceAlertMutedBold: return "\u{f835}"
        case .telepresenceAlertMutedLight: return "\u{f836}"
        case .telepresenceAlertMutedRegular: return "\u{f837}"
        case .telepresenceAlertRegular: return "\u{f838}"
        case .telepresenceBold: return "\u{f839}"
        case .telepresenceIx5000Bold: return "\u{f83a}"
        case .telepresenceIx5000Light: return "\u{f83b}"
        case .telepresenceIx5000Regular: return "\u{f83c}"
        case .telepresenceLight: return "\u{f83d}"
        case .telepresencePrivateBold: return "\u{f83e}"
        case .telepresencePrivateLight: return "\u{f83f}"
        case .telepresencePrivateRegular: return "\u{f840}"
        case .telepresenceRegular: return "\u{f841}"
        case .temperatureBold: return "\u{f842}"
        case .temperatureLight: return "\u{f843}"
        case .temperatureRegular: return "\u{f844}"
        case .textBold: return "\u{f845}"
        case .textCodeBlockBold: return "\u{f846}"
        case .textCodeBlockLight: return "\u{f847}"
        case .textCodeBlockRegular: return "\u{f848}"
        case .textHighlightBold: return "\u{f849}"
        case .textHighlightLight: return "\u{f84a}"
        case .textHighlightRegular: return "\u{f84b}"
        case .textLight: return "\u{f84c}"
        case .textRegular: return "\u{f84d}"
        case .threeDObjectBold: return "\u{f84e}"
        case .threeDObjectLight: return "\u{f84f}"
        case .threeDObjectRegular: return "\u{f850}"
        case .tooFastBold: return "\u{f851}"
        case .tooFastLight: return "\u{f852}"
        case .tooFastRegular: return "\u{f853}"
        case .tooSlowBold: return "\u{f854}"
        case .tooSlowLight: return "\u{f855}"
        case .tooSlowRegular: return "\u{f856}"
        case .toolsBold: return "\u{f857}"
        case .toolsLight: return "\u{f858}"
        case .toolsRegular: return "\u{f859}"
        case .touch10Bold: return "\u{f85a}"
        case .touch10Light: return "\u{f85b}"
        case .touch10Regular: return "\u{f85c}"
        case .transcriptBold: return "\u{f85d}"
        case .transcriptLight: return "\u{f85e}"
        case .transcriptRegular: return "\u{f85f}"
        case .ucmCloudBold: return "\u{f860}"
        case .ucmCloudLight: return "\u{f861}"
        case .ucmCloudRegular: return "\u{f862}"
        case .underlineBold: return "\u{f863}"
        case .underlineLight: return "\u{f864}"
        case .underlineRegular: return "\u{f865}"
        case .undoBold: return "\u{f866}"
        case .undoLight: return "\u{f867}"
        case .undoRegular: return "\u{f868}"
        case .unlinkBold: return "\u{f869}"
        case .unlinkLight: return "\u{f86a}"
        case .unlinkRegular: return "\u{f86b}"
        case .unreadBold: return "\u{f86c}"
        case .unreadFilled: return "\u{f86d}"
        case .unreadLight: return "\u{f86e}"
        case .unreadRegular: return "\u{f86f}"
        case .unsecureUnlockedBold: return "\u{f870}"
        case .unsecureUnlockedFilled: return "\u{f871}"
        case .unsecureUnlockedLight: return "\u{f872}"
        case .unsecureUnlockedRegular: return "\u{f873}"
        case .unsortedBold: return "\u{f874}"
        case .unsortedLight: return "\u{f875}"
        case .unsortedRegular: return "\u{f876}"
        case .updateFileShareBold: return "\u{f877}"
        case .updateFileShareLight: return "\u{f878}"
        case .updateFileShareRegular: return "\u{f879}"
        case .upgradeBold: return "\u{f87a}"
        case .upgradeFilled: return "\u{f87b}"
        case .upgradeLight: return "\u{f87c}"
        case .upgradeRegular: return "\u{f87d}"
        case .uploadBold: return "\u{f87e}"
        case .uploadLight: return "\u{f87f}"
        case .uploadRegular: return "\u{f880}"
        case .usbBold: return "\u{f881}"
        case .usbHeadsetBold: return "\u{f882}"
        case .usbHeadsetLight: return "\u{f883}"
        case .usbHeadsetMutedBold: return "\u{f884}"
        case .usbHeadsetMutedLight: return "\u{f885}"
        case .usbHeadsetMutedRegular: return "\u{f886}"
        case .usbHeadsetRegular: return "\u{f887}"
        case .usbLight: return "\u{f888}"
        case .usbRegular: return "\u{f889}"
        case .userBold: return "\u{f88a}"
        case .userLight: return "\u{f88b}"
        case .userRegular: return "\u{f88c}"
        case .vcsBold: return "\u{f88d}"
        case .vcsLight: return "\u{f88e}"
        case .vcsRegular: return "\u{f88f}"
        case .videoBlurBold: return "\u{f890}"
        case .videoBlurFilled: return "\u{f891}"
        case .videoBlurLight: return "\u{f892}"
        case .videoBlurRegular: return "\u{f893}"
        case .videoBold: return "\u{f894}"
        case .videoEffectBold: return "\u{f895}"
        case .videoEffectFilled: return "\u{f896}"
        case .videoEffectLight: return "\u{f897}"
        case .videoEffectRegular: return "\u{f898}"
        case .videoFilled: return "\u{f899}"
        case .videoLayoutBold: return "\u{f89a}"
        case .videoLayoutEqualBold: return "\u{f89b}"
        case .videoLayoutEqualDualBold: return "\u{f89c}"
        case .videoLayoutEqualDualLight: return "\u{f89d}"
        case .videoLayoutEqualDualRegular: return "\u{f89e}"
        case .videoLayoutEqualFilled: return "\u{f89f}"
        case .videoLayoutEqualLight: return "\u{f8a0}"
        case .videoLayoutEqualRegular: return "\u{f8a1}"
        case .videoLayoutLight: return "\u{f8a2}"
        case .videoLayoutOverlayBold: return "\u{f8a3}"
        case .videoLayoutOverlayLight: return "\u{f8a4}"
        case .videoLayoutOverlayRegular: return "\u{f8a5}"
        case .videoLayoutProminentBold: return "\u{f8a6}"
        case .videoLayoutProminentLight: return "\u{f8a7}"
        case .videoLayoutProminentRegular: return "\u{f8a8}"
        case .videoLayoutRegular: return "\u{f8a9}"
        case .videoLayoutShareDominantBold: return "\u{f8aa}"
        case .videoLayoutShareDominantLight: return "\u{f8ab}"
        case .videoLayoutShareDominantRegular: return "\u{f8ac}"
        case .videoLayoutSingleBold: return "\u{f8ad}"
        case .videoLayoutSingleLight: return "\u{f8ae}"
        case .videoLayoutSingleRegular: return "\u{f8af}"
        case .videoLayoutStackBold: return "\u{f8b0}"
        case .videoLayoutStackFilled: return "\u{f8b1}"
        case .videoLayoutStackLight: return "\u{f8b2}"
        case .videoLayoutStackRegular: return "\u{f8b3}"
        case .videoLayoutVideoDominantBold: return "\u{f8b4}"
        case .videoLayoutVideoDominantLight: return "\u{f8b5}"
        case .videoLayoutVideoDominantRegular: return "\u{f8b6}"
        case .videoLight: return "\u{f8b7}"
        case .videoPlusBold: return "\u{f8b8}"
        case .videoPlusFilled: return "\u{f8b9}"
        case .videoPlusLight: return "\u{f8ba}"
        case .videoPlusRegular: return "\u{f8bb}"
        case .videoRegular: return "\u{f8bc}"
        case .videoSpeakerTrackBold: return "\u{f8bd}"
        case .videoSpeakerTrackFilled: return "\u{f8be}"
        case .videoSpeakerTrackLight: return "\u{f8bf}"
        case .videoSpeakerTrackRegular: return "\u{f8c0}"
        case .viewAllBold: return "\u{f8c1}"
        case .viewAllLight: return "\u{f8c2}"
        case .viewAllRegular: return "\u{f8c3}"
        case .viewListBold: return "\u{f8c4}"
        case .viewListLight: return "\u{f8c5}"
        case .viewListRegular: return "\u{f8c6}"
        case .viewStackedBold: return "\u{f8c7}"
        case .viewStackedLight: return "\u{f8c8}"
        case .viewStackedRegular: return "\u{f8c9}"
        case .viewThumbnailBold: return "\u{f8ca}"
        case .viewThumbnailLight: return "\u{f8cb}"
        case .viewThumbnailRegular: return "\u{f8cc}"
        case .voicemailBold: return "\u{f8cd}"
        case .voicemailFilled: return "\u{f8ce}"
        case .voicemailLight: return "\u{f8cf}"
        case .voicemailRegular: return "\u{f8d0}"
        case .wallpaperBold: return "\u{f8d1}"
        case .wallpaperLight: return "\u{f8d2}"
        case .wallpaperRegular: return "\u{f8d3}"
        case .warningBadgeFilled: return "\u{f8d4}"
        case .warningBold: return "\u{f8d5}"
        case .warningFilled: return "\u{f8d6}"
        case .warningLight: return "\u{f8d7}"
        case .warningRegular: return "\u{f8d8}"
        case .webexBoardBold: return "\u{f8d9}"
        case .webexBoardLight: return "\u{f8da}"
        case .webexBoardRegular: return "\u{f8db}"
        case .webexCodecPlusBold: return "\u{f8dc}"
        case .webexCodecPlusLight: return "\u{f8dd}"
        case .webexCodecPlusRegular: return "\u{f8de}"
        case .webexDeskCameraBold: return "\u{f8df}"
        case .webexDeskCameraLight: return "\u{f8e0}"
        case .webexDeskCameraRegular: return "\u{f8e1}"
        case .webexHelixFilled: return "\u{f8e2}"
        case .webexMeetingsBold: return "\u{f8e3}"
        case .webexMeetingsFilled: return "\u{f8e4}"
        case .webexMeetingsLight: return "\u{f8e5}"
        case .webexMeetingsRegular: return "\u{f8e6}"
        case .webexQuadCameraBold: return "\u{f8e7}"
        case .webexQuadCameraLight: return "\u{f8e8}"
        case .webexQuadCameraRegular: return "\u{f8e9}"
        case .webexRoomKitBold: return "\u{f8ea}"
        case .webexRoomKitLight: return "\u{f8eb}"
        case .webexRoomKitPlusBold: return "\u{f8ec}"
        case .webexRoomKitPlusLight: return "\u{f8ed}"
        case .webexRoomKitPlusRegular: return "\u{f8ee}"
        case .webexRoomKitRegular: return "\u{f8ef}"
        case .webexShareBold: return "\u{f8f0}"
        case .webexShareLight: return "\u{f8f1}"
        case .webexShareRegular: return "\u{f8f2}"
        case .webexTeamsBold: return "\u{f8f3}"
        case .webexTeamsFilled: return "\u{f8f4}"
        case .webexTeamsLight: return "\u{f8f5}"
        case .webexTeamsNewBold: return "\u{f8f6}"
        case .webexTeamsNewFilled: return "\u{f8f7}"
        case .webexTeamsNewLight: return "\u{f8f8}"
        case .webexTeamsNewRegular: return "\u{f8f9}"
        case .webexTeamsRegular: return "\u{f8fa}"
        case .whiteboardBold: return "\u{f8fb}"
        case .whiteboardContentBold: return "\u{f8fc}"
        case .whiteboardContentLight: return "\u{f8fd}"
        case .whiteboardContentRegular: return "\u{f8fe}"
        case .whiteboardFilled: return "\u{f8ff}"
        case .whiteboardLight: return "\u{f900}"
        case .whiteboardRegular: return "\u{f901}"
        case .widgetBold: return "\u{f902}"
        case .widgetFilled: return "\u{f903}"
        case .widgetLight: return "\u{f904}"
        case .widgetRegular: return "\u{f905}"
        case .wifiBold: return "\u{f906}"
        case .wifiErrorBold: return "\u{f907}"
        case .wifiErrorLight: return "\u{f908}"
        case .wifiErrorRegular: return "\u{f909}"
        case .wifiLight: return "\u{f90a}"
        case .wifiRegular: return "\u{f90b}"
        case .windowCornerScrubBold: return "\u{f90c}"
        case .windowCornerScrubLight: return "\u{f90d}"
        case .windowCornerScrubRegular: return "\u{f90e}"
        case .windowVerticalScrubBold: return "\u{f90f}"
        case .windowVerticalScrubLight: return "\u{f910}"
        case .windowVerticalScrubRegular: return "\u{f911}"
        case .workphoneBold: return "\u{f912}"
        case .workphoneLight: return "\u{f913}"
        case .workphoneRegular: return "\u{f914}"
        case .zoomInBold: return "\u{f915}"
        case .zoomInLight: return "\u{f916}"
        case .zoomInRegular: return "\u{f917}"
        case .zoomOutBold: return "\u{f918}"
        case .zoomOutLight: return "\u{f919}"
        case .zoomOutRegular: return "\u{f91a}"
