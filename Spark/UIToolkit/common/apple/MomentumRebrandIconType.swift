...
@objc public enum MomentumRebrandIconType: Int {
    ...
    public var ligature: String {
        ...
        case .checkCircleBadgeFilled: return "\u{f2a6}"
        case .checkCircleBold: return "\u{f2a7}"
        case .checkCircleFilled: return "\u{f2a8}"
        case .checkCircleLight: return "\u{f2a9}"
        case .checkCircleRegular: return "\u{f2aa}"
        case .checkLight: return "\u{f2ab}"
        case .checkRegular: return "\u{f2ac}"
        case .clearBold: return "\u{f2ad}"
        case .clearFilled: return "\u{f2ae}"
        case .clearLight: return "\u{f2af}"
        case .clearRegular: return "\u{f2b0}"
        case .closeSpaceBold: return "\u{f2b1}"
        case .closeSpaceLight: return "\u{f2b2}"
        case .closeSpaceRegular: return "\u{f2b3}"
        case .closedCaptionBadgeBold: return "\u{f2b4}"
        case .closedCaptionBadgeLight: return "\u{f2b5}"
        case .closedCaptionBadgeRegular: return "\u{f2b6}"
        case .closedCaptionsBold: return "\u{f2b7}"
        case .closedCaptionsFilled: return "\u{f2b8}"
        case .closedCaptionsLight: return "\u{f2b9}"
        case .closedCaptionsRegular: return "\u{f2ba}"
        case .cloudBold: return "\u{f2bb}"
        case .cloudFilled: return "\u{f2bc}"
        case .cloudFrameBold: return "\u{f2bd}"
        case .cloudFrameFilled: return "\u{f2be}"
        case .cloudFrameRegular: return "\u{f2bf}"
        case .cloudFramedFilled: return "\u{f2c0}"
        case .cloudFramedLight: return "\u{f2c1}"
        case .cloudLight: return "\u{f2c2}"
        case .cloudRegular: return "\u{f2c3}"
        case .cloudUploadBold: return "\u{f2c4}"
        case .cloudUploadLight: return "\u{f2c5}"
        case .cloudUploadRegular: return "\u{f2c6}"
        case .codeBlockBold: return "\u{f2c7}"
        case .codeBlockLight: return "\u{f2c8}"
        case .codeBlockRegular: return "\u{f2c9}"
        case .colorBold: return "\u{f2ca}"
        case .colorLight: return "\u{f2cb}"
        case .colorRegular: return "\u{f2cc}"
        case .commentingBold: return "\u{f2cd}"
        case .commentingFilled: return "\u{f2ce}"
        case .commentingLight: return "\u{f2cf}"
        case .commentingRegular: return "\u{f2d0}"
        case .companyBold: return "\u{f2d1}"
        case .companyLight: return "\u{f2d2}"
        case .companyRegular: return "\u{f2d3}"
        case .computerBold: return "\u{f2d4}"
        case .computerLight: return "\u{f2d5}"
        case .computerRegular: return "\u{f2d6}"
        case .conciergeBold: return "\u{f2d7}"
        case .conciergeLight: return "\u{f2d8}"
        case .conciergeRegular: return "\u{f2d9}"
        case .contactCardBold: return "\u{f2da}"
        case .contactCardFilled: return "\u{f2db}"
        case .contactCardLight: return "\u{f2dc}"
        case .contactCardRegular: return "\u{f2dd}"
        case .contactGroupBold: return "\u{f2de}"
        case .contactGroupFilled: return "\u{f2df}"
        case .contactGroupLight: return "\u{f2e0}"
        case .contactGroupRegular: return "\u{f2e1}"
        case .contactsBold: return "\u{f2e2}"
        case .contactsFilled: return "\u{f2e3}"
        case .contactsLight: return "\u{f2e4}"
        case .contactsRegular: return "\u{f2e5}"
        case .contentDownloadBold: return "\u{f2e6}"
        case .contentDownloadFilled: return "\u{f2e7}"
        case .contentDownloadLight: return "\u{f2e8}"
        case .contentDownloadRegular: return "\u{f2e9}"
        case .contentShareBold: return "\u{f2ea}"
        case .contentShareLight: return "\u{f2eb}"
        case .contentShareRegular: return "\u{f2ec}"
        case .contrastBold: return "\u{f2ed}"
        case .contrastLight: return "\u{f2ee}"
        case .contrastRegular: return "\u{f2ef}"
        case .copyBold: return "\u{f2f0}"
        case .copyLight: return "\u{f2f1}"
        case .copyRegular: return "\u{f2f2}"
        case .cpuBold: return "\u{f2f3}"
        case .cpuLight: return "\u{f2f4}"
        case .cpuRegular: return "\u{f2f5}"
        case .cropBold: return "\u{f2f6}"
        case .cropLight: return "\u{f2f7}"
        case .cropRegular: return "\u{f2f8}"
        case .cucmConnectionBold: return "\u{f2f9}"
        case .cucmConnectionLight: return "\u{f2fa}"
        case .cucmConnectionRegular: return "\u{f2fb}"
        case .dashboardBold: return "\u{f2fc}"
        case .dashboardFilled: return "\u{f2fd}"
        case .dashboardLight: return "\u{f2fe}"
        case .dashboardRegular: return "\u{f2ff}"
        case .deleteBold: return "\u{f300}"
        case .deleteLight: return "\u{f301}"
        case .deleteRegular: return "\u{f302}"
        case .deskPhoneBold: return "\u{f303}"
        case .deskPhoneFilled: return "\u{f304}"
        case .deskPhoneLight: return "\u{f305}"
        case .deskPhoneRegular: return "\u{f306}"
        case .deskPhoneWarningBold: return "\u{f307}"
        case .deskPhoneWarningLight: return "\u{f308}"
        case .deskPhoneWarningRegular: return "\u{f309}"
        case .deviceConnectionBold: return "\u{f30a}"
        case .deviceConnectionFilled: return "\u{f30b}"
        case .deviceConnectionLight: return "\u{f30c}"
        case .deviceConnectionRegular: return "\u{f30d}"
        case .diagnosticsBold: return "\u{f30e}"
        case .diagnosticsLight: return "\u{f30f}"
        case .diagnosticsRegular: return "\u{f310}"
        case .dialpadBold: return "\u{f311}"
        case .dialpadLight: return "\u{f312}"
        case .dialpadRegular: return "\u{f313}"
        case .directoryBold: return "\u{f314}"
        case .directoryLight: return "\u{f315}"
        case .directoryRegular: return "\u{f316}"
        case .discBold: return "\u{f317}"
        case .discDisconnectedBold: return "\u{f318}"
        case .discDisconnectedLight: return "\u{f319}"
        case .discDisconnectedRegular: return "\u{f31a}"
        case .discLight: return "\u{f31b}"
        case .discRegular: return "\u{f31c}"
        case .disconnectBold: return "\u{f31d}"
        case .disconnectLight: return "\u{f31e}"
        case .disconnectRegular: return "\u{f31f}"
        case .dislikeBold: return "\u{f320}"
        case .dislikeFilled: return "\u{f321}"
        case .dislikeLight: return "\u{f322}"
        case .dislikeRegular: return "\u{f323}"
        case .displayBold: return "\u{f324}"
        case .displayInputBold: return "\u{f325}"
        case .displayInputLight: return "\u{f326}"
        case .displayInputRegular: return "\u{f327}"
        case .displayLight: return "\u{f328}"
        case .displayRegular: return "\u{f329}"
        case .displayWarningBold: return "\u{f32a}"
        case .displayWarningLight: return "\u{f32b}"
        case .displayWarningRegular: return "\u{f32c}"
        case .dndPresenceBold: return "\u{f32d}"
        case .dndPresenceFilled: return "\u{f32e}"
        case .dndPresenceLight: return "\u{f32f}"
        case .dndPresenceRegular: return "\u{f330}"
        case .dndPresenceSmallFilled: return "\u{f331}"
        case .documentBold: return "\u{f332}"
        case .documentCameraBold: return "\u{f333}"
        case .documentCameraDisconnectedBold: return "\u{f334}"
        case .documentCameraDisconnectedLight: return "\u{f335}"
        case .documentCameraDisconnectedRegular: return "\u{f336}"
        case .documentCameraLight: return "\u{f337}"
        case .documentCameraRegular: return "\u{f338}"
        case .documentCreateBold: return "\u{f339}"
        case .documentCreateFilled: return "\u{f33a}"
        case .documentCreateLight: return "\u{f33b}"
        case .documentCreateRegular: return "\u{f33c}"
        case .documentFilled: return "\u{f33d}"
        case .documentLight: return "\u{f33e}"
        case .documentMoveBold: return "\u{f33f}"
        case .documentMoveFilled: return "\u{f340}"
        case .documentMoveLight: return "\u{f341}"
        case .documentMoveRegular: return "\u{f342}"
        case .documentRegular: return "\u{f343}"
        case .documentShareBold: return "\u{f344}"
        case .documentShareFilled: return "\u{f345}"
        case .documentShareLight: return "\u{f346}"
        case .documentShareRegular: return "\u{f347}"
        case .donutChartBold: return "\u{f348}"
        case .donutChartFilled: return "\u{f349}"
        case .donutChartLight: return "\u{f34a}"
        case .donutChartRegular: return "\u{f34b}"
        case .downloadBold: return "\u{f34c}"
        case .downloadFilled: return "\u{f34d}"
        case .downloadLight: return "\u{f34e}"
        case .downloadRegular: return "\u{f34f}"
        case .dragBold: return "\u{f350}"
        case .dragLight: return "\u{f351}"
        case .dragRegular: return "\u{f352}"
        case .dx70Bold: return "\u{f353}"
        case .dx70Light: return "\u{f354}"
        case .dx70Regular: return "\u{f355}"
        case .dx80Bold: return "\u{f356}"
        case .dx80Filled: return "\u{f357}"
        case .dx80Light: return "\u{f358}"
        case .dx80Regular: return "\u{f359}"
        case .editBold: return "\u{f35a}"
        case .editLight: return "\u{f35b}"
        case .editRegular: return "\u{f35c}"
        case .emailBold: return "\u{f35d}"
        case .emailFilled: return "\u{f35e}"
        case .emailInviteBold: return "\u{f35f}"
        case .emailInviteLight: return "\u{f360}"
        case .emailInviteRegular: return "\u{f361}"
        case .emailLight: return "\u{f362}"
        case .emailReadBold: return "\u{f363}"
        case .emailReadFilled: return "\u{f364}"
        case .emailReadLight: return "\u{f365}"
        case .emailReadRegular: return "\u{f366}"
        case .emailRegular: return "\u{f367}"
        case .emojiHappyBold: return "\u{f368}"
        case .emojiHappyFilled: return "\u{f369}"
        case .emojiHappyLight: return "\u{f36a}"
        case .emojiHappyRegular: return "\u{f36b}"
        case .emojiPassiveBold: return "\u{f36c}"
        case .emojiPassiveFilled: return "\u{f36d}"
        case .emojiPassiveLight: return "\u{f36e}"
        case .emojiPassiveRegular: return "\u{f36f}"
        case .emojiSadBold: return "\u{f370}"
        case .emojiSadFilled: return "\u{f371}"
        case .emojiSadLight: return "\u{f372}"
        case .emojiSadRegular: return "\u{f373}"
        case .encryptionFilled: return "\u{f374}"
        case .endRemoteDesktopControlBold: return "\u{f375}"
        case .endRemoteDesktopControlLight: return "\u{f376}"
        case .endRemoteDesktopControlRegular: return "\u{f377}"
        case .endToEndEncryptionFilled: return "\u{f378}"
        case .endpointBlockedBold: return "\u{f379}"
        case .endpointBlockedLight: return "\u{f37a}"
        case .endpointBlockedRegular: return "\u{f37b}"
        case .endpointBold: return "\u{f37c}"
        case .endpointG270Bold: return "\u{f37d}"
        case .endpointG270DualBold: return "\u{f37e}"
        case .endpointG270DualLight: return "\u{f37f}"
        case .endpointG270DualRegular: return "\u{f380}"
        case .endpointG270Light: return "\u{f381}"
        case .endpointG270Regular: return "\u{f382}"
        case .endpointG2Bold: return "\u{f383}"
        case .endpointG2Light: return "\u{f384}"
        case .endpointG2Regular: return "\u{f385}"
        case .endpointG2StandBold: return "\u{f386}"
        case .endpointG2StandLight: return "\u{f387}"
        case .endpointG2StandRegular: return "\u{f388}"
        case .endpointLight: return "\u{f389}"
        case .endpointMx800Bold: return "\u{f38a}"
        case .endpointMx800DualBold: return "\u{f38b}"
        case .endpointMx800DualLight: return "\u{f38c}"
        case .endpointMx800DualRegular: return "\u{f38d}"
        case .endpointMx800Light: return "\u{f38e}"
        case .endpointMx800Regular: return "\u{f38f}"
        case .endpointRegular: return "\u{f390}"
        case .endpointStandBold: return "\u{f391}"
        case .endpointStandFilled: return "\u{f392}"
        case .endpointStandLight: return "\u{f393}"
        case .endpointStandRegular: return "\u{f394}"
        case .endpointWarningBold: return "\u{f395}"
        case .endpointWarningLight: return "\u{f396}"
        case .endpointWarningRegular: return "\u{f397}"
        case .enterBold: return "\u{f398}"
        case .enterLight: return "\u{f399}"
        case .enterRegular: return "\u{f39a}"
        case .enterRoomBold: return "\u{f39b}"
        case .enterRoomLight: return "\u{f39c}"
        case .enterRoomRegular: return "\u{f39d}"
        case .eraserBold: return "\u{f39e}"
        case .eraserFilled: return "\u{f39f}"
        case .eraserLight: return "\u{f3a0}"
        case .eraserRegular: return "\u{f3a1}"
        case .errorLegacyBadgeFilled: return "\u{f3a2}"
        case .errorLegacyBold: return "\u{f3a3}"
        case .errorLegacyFilled: return "\u{f3a4}"
        case .errorLegacyLight: return "\u{f3a5}"
        case .errorLegacyRegular: return "\u{f3a6}"
        case .ethernetBold: return "\u{f3a7}"
        case .ethernetLight: return "\u{f3a8}"
        case .ethernetRegular: return "\u{f3a9}"
        case .exitRoomBold: return "\u{f3aa}"
        case .exitRoomLight: return "\u{f3ab}"
        case .exitRoomRegular: return "\u{f3ac}"
        case .exploreBold: return "\u{f3ad}"
        case .exploreLight: return "\u{f3ae}"
        case .exploreRegular: return "\u{f3af}"
        case .exportBold: return "\u{f3b0}"
        case .exportLight: return "\u{f3b1}"
        case .exportRegular: return "\u{f3b2}"
        case .extensionMobilityBold: return "\u{f3b3}"
        case .extensionMobilityLight: return "\u{f3b4}"
        case .extensionMobilityRegular: return "\u{f3b5}"
        case .externalMessageBold: return "\u{f3b6}"
        case .externalMessageLight: return "\u{f3b7}"
        case .externalMessageRegular: return "\u{f3b8}"
        case .externalUserBold: return "\u{f3b9}"
        case .externalUserLight: return "\u{f3ba}"
        case .externalUserRegular: return "\u{f3bb}"
        case .familyFontBold: return "\u{f3bc}"
        case .familyFontLight: return "\u{f3bd}"
        case .familyFontRegular: return "\u{f3be}"
        case .fastForwardBold: return "\u{f3bf}"
        case .fastForwardLight: return "\u{f3c0}"
        case .fastForwardRegular: return "\u{f3c1}"
        case .favoriteBold: return "\u{f3c2}"
        case .favoriteFilled: return "\u{f3c3}"
        case .favoriteLight: return "\u{f3c4}"
        case .favoriteRegular: return "\u{f3c5}"
        case .favoritesBold: return "\u{f3c6}"
        case .favoritesFilled: return "\u{f3c7}"
        case .favoritesLight: return "\u{f3c8}"
        case .favoritesRegular: return "\u{f3c9}"
        case .fbwBold: return "\u{f3ca}"
        case .fbwFilled: return "\u{f3cb}"
        case .fbwLight: return "\u{f3cc}"
        case .fbwRegular: return "\u{f3cd}"
        case .ffwBold: return "\u{f3ce}"
        case .ffwFilled: return "\u{f3cf}"
        case .ffwLight: return "\u{f3d0}"
        case .ffwRegular: return "\u{f3d1}"
        case .file3DBold: return "\u{f3d2}"
        case .file3DFilled: return "\u{f3d3}"
        case .file3DLight: return "\u{f3d4}"
        case .file3DRegular: return "\u{f3d5}"
        case .fileAnalysisBold: return "\u{f3d6}"
        case .fileAnalysisFilled: return "\u{f3d7}"
        case .fileAnalysisLight: return "\u{f3d8}"
        case .fileAnalysisRegular: return "\u{f3d9}"
        case .fileAnnotationBold: return "\u{f3da}"
        case .fileAnnotationFilled: return "\u{f3db}"
        case .fileAnnotationLight: return "\u{f3dc}"
        case .fileAnnotationRegular: return "\u{f3dd}"
        case .fileAudioBold: return "\u{f3de}"
        case .fileAudioFilled: return "\u{f3df}"
        case .fileAudioLight: return "\u{f3e0}"
        case .fileAudioRegular: return "\u{f3e1}"
        case .fileBugBold: return "\u{f3e2}"
        case .fileBugFilled: return "\u{f3e3}"
        case .fileBugLight: return "\u{f3e4}"
        case .fileBugRegular: return "\u{f3e5}"
        case .fileCodeBold: return "\u{f3e6}"
        case .fileCodeFilled: return "\u{f3e7}"
        case .fileCodeLight: return "\u{f3e8}"
        case .fileCodeRegular: return "\u{f3e9}"
        case .fileDashboardBold: return "\u{f3ea}"
        case .fileDashboardFilled: return "\u{f3eb}"
        case .fileDashboardLight: return "\u{f3ec}"
        case .fileDashboardRegular: return "\u{f3ed}"
        case .fileExcelBold: return "\u{f3ee}"
        case .fileExcelFilled: return "\u{f3ef}"
        case .fileExcelLight: return "\u{f3f0}"
        case .fileExcelRegular: return "\u{f3f1}"
        case .fileGraphBold: return "\u{f3f2}"
        case .fileGraphFilled: return "\u{f3f3}"
        case .fileGraphLight: return "\u{f3f4}"
        case .fileGraphRegular: return "\u{f3f5}"
        case .fileImageBold: return "\u{f3f6}"
        case .fileImageFilled: return "\u{f3f7}"
        case .fileImageLight: return "\u{f3f8}"
        case .fileImageRegular: return "\u{f3f9}"
        case .fileKeynoteBold: return "\u{f3fa}"
        case .fileKeynoteFilled: return "\u{f3fb}"
        case .fileKeynoteLight: return "\u{f3fc}"
        case .fileKeynoteRegular: return "\u{f3fd}"
        case .fileLockedBold: return "\u{f3fe}"
        case .fileLockedFilled: return "\u{f3ff}"
        case .fileLockedLight: return "\u{f400}"
        case .fileLockedRegular: return "\u{f401}"
        case .fileMissingBold: return "\u{f402}"
        case .fileMissingFilled: return "\u{f403}"
        case .fileMissingLight: return "\u{f404}"
        case .fileMissingRegular: return "\u{f405}"
        case .fileMusicBold: return "\u{f406}"
        case .fileMusicFilled: return "\u{f407}"
        case .fileMusicLight: return "\u{f408}"
        case .fileMusicRegular: return "\u{f409}"
        case .fileOnenoteBold: return "\u{f40a}"
        case .fileOnenoteFilled: return "\u{f40b}"
        case .fileOnenoteLight: return "\u{f40c}"
        case .fileOnenoteRegular: return "\u{f40d}"
        case .filePdfBold: return "\u{f40e}"
        case .filePdfFilled: return "\u{f40f}"
        case .filePdfLight: return "\u{f410}"
        case .filePdfRegular: return "\u{f411}"
        case .filePowerpointBold: return "\u{f412}"
        case .filePowerpointFilled: return "\u{f413}"
        case .filePowerpointLight: return "\u{f414}"
        case .filePowerpointRegular: return "\u{f415}"
        case .fileSpreadsheetBold: return "\u{f416}"
        case .fileSpreadsheetFilled: return "\u{f417}"
        case .fileSpreadsheetLight: return "\u{f418}"
        case .fileSpreadsheetRegular: return "\u{f419}"
        case .fileTextBold: return "\u{f41a}"
        case .fileTextFilled: return "\u{f41b}"
        case .fileTextLight: return "\u{f41c}"
        case .fileTextRegular: return "\u{f41d}"
        case .fileVectorBold: return "\u{f41e}"
        case .fileVectorFilled: return "\u{f41f}"
        case .fileVectorLight: return "\u{f420}"
        case .fileVectorRegular: return "\u{f421}"
        case .fileVideoBold: return "\u{f422}"
        case .fileVideoFilled: return "\u{f423}"
        case .fileVideoLight: return "\u{f424}"
        case .fileVideoRegular: return "\u{f425}"
        case .fileWordBold: return "\u{f426}"
        case .fileWordFilled: return "\u{f427}"
        case .fileWordLight: return "\u{f428}"
        case .fileWordRegular: return "\u{f429}"
        case .fileZipBold: return "\u{f42a}"
        case .fileZipFilled: return "\u{f42b}"
        case .fileZipLight: return "\u{f42c}"
        case .fileZipRegular: return "\u{f42d}"
        case .filesBold: return "\u{f42e}"
        case .filesFilled: return "\u{f42f}"
        case .filesLight: return "\u{f430}"
        case .filesRegular: return "\u{f431}"
        case .filterBold: return "\u{f432}"
        case .filterCircleBold: return "\u{f433}"
        case .filterCircleFilled: return "\u{f434}"
        case .filterCircleLight: return "\u{f435}"
        case .filterCircleRegular: return "\u{f436}"
        case .filterLight: return "\u{f437}"
        case .filterRegular: return "\u{f438}"
        case .fitToWidthBold: return "\u{f439}"
        case .fitToWidthLight: return "\u{f43a}"
        case .fitToWidthRegular: return "\u{f43b}"
        case .fitToWindowBold: return "\u{f43c}"
        case .fitToWindowExitBold: return "\u{f43d}"
        case .fitToWindowExitLight: return "\u{f43e}"
        case .fitToWindowExitRegular: return "\u{f43f}"
        case .fitToWindowLight: return "\u{f440}"
        case .fitToWindowRegular: return "\u{f441}"
        case .flagBold: return "\u{f442}"
        case .flagCircleBold: return "\u{f443}"
        case .flagCircleFilled: return "\u{f444}"
        case .flagCircleLight: return "\u{f445}"
        case .flagCircleRegular: return "\u{f446}"
        case .flagFilled: return "\u{f447}"
        case .flagLight: return "\u{f448}"
        case .flagRegular: return "\u{f449}"
        case .folderBold: return "\u{f44a}"
        case .folderEditBold: return "\u{f44b}"
        case .folderEditLight: return "\u{f44c}"
        case .folderEditRegular: return "\u{f44d}"
        case .folderLight: return "\u{f44e}"
        case .folderLockBold: return "\u{f44f}"
        case .folderLockLight: return "\u{f450}"
        case .folderLockRegular: return "\u{f451}"
        case .folderRegular: return "\u{f452}"
        case .folderViewBold: return "\u{f453}"
        case .folderViewLight: return "\u{f454}"
        case .folderViewRegular: return "\u{f455}"
        case .foodBold: return "\u{f456}"
        case .foodLight: return "\u{f457}"
        case .foodRegular: return "\u{f458}"
        case .formatBold: return "\u{f459}"
        case .formatControlPanelDraggerBold: return "\u{f45a}"
        case .formatControlPanelDraggerHorizontalBold: return "\u{f45b}"
        case .formatControlPanelDraggerHorizontalLight: return "\u{f45c}"
        case .formatControlPanelDraggerHorizontalRegular: return "\u{f45d}"
        case .formatControlPanelDraggerLight: return "\u{f45e}"
        case .formatControlPanelDraggerRegular: return "\u{f45f}"
        case .formatDefaultAppBold: return "\u{f460}"
        case .formatDefaultAppLight: return "\u{f461}"
        case .formatDefaultAppRegular: return "\u{f462}"
        case .formatLight: return "\u{f463}"
        case .formatPanelControlBarBold: return "\u{f464}"
        case .formatPanelControlBarLight: return "\u{f465}"
        case .formatPanelControlBarRegular: return "\u{f466}"
        case .formatPanelControlDownBold: return "\u{f467}"
        case .formatPanelControlDownLight: return "\u{f468}"
        case .formatPanelControlDownRegular: return "\u{f469}"
        case .formatPanelControlLeftBold: return "\u{f46a}"
        case .formatPanelControlLeftLight: return "\u{f46b}"
        case .formatPanelControlLeftRegular: return "\u{f46c}"
        case .formatPanelControlRightBold: return "\u{f46d}"
        case .formatPanelControlRightLight: return "\u{f46e}"
        case .formatPanelControlRightRegular: return "\u{f46f}"
        case .formatPanelControlUpBold: return "\u{f470}"
        case .formatPanelControlUpDownBold: return "\u{f471}"
        case .formatPanelControlUpDownLight: return "\u{f472}"
        case .formatPanelControlUpDownRegular: return "\u{f473}"
        case .formatPanelControlUpLight: return "\u{f474}"
        case .formatPanelControlUpRegular: return "\u{f475}"
        case .formatRegular: return "\u{f476}"
        case .formatViewMixedBold: return "\u{f477}"
        case .formatViewMixedLight: return "\u{f478}"
        case .formatViewMixedRegular: return "\u{f479}"
        case .forwardMessageBold: return "\u{f47a}"
        case .forwardMessageFilled: return "\u{f47b}"
        case .forwardMessageLight: return "\u{f47c}"
        case .forwardMessageRegular: return "\u{f47d}"
        case .fourWayNavigationBold: return "\u{f47e}"
        case .fourWayNavigationLight: return "\u{f47f}"
        case .fourWayNavigationRegular: return "\u{f480}"
        case .fullscreenBold: return "\u{f481}"
        case .fullscreenExitBold: return "\u{f482}"
        case .fullscreenExitLight: return "\u{f483}"
        case .fullscreenExitRegular: return "\u{f484}"
        case .fullscreenLight: return "\u{f485}"
        case .fullscreenRegular: return "\u{f486}"
        case .genericDeviceVideoBold: return "\u{f487}"
        case .genericDeviceVideoFilled: return "\u{f488}"
        case .genericDeviceVideoLight: return "\u{f489}"
        case .genericDeviceVideoRegular: return "\u{f48a}"
        case .gifBold: return "\u{f48b}"
        case .gifFilled: return "\u{f48c}"
        case .gifLight: return "\u{f48d}"
        case .gifRegular: return "\u{f48e}"
        case .guestIssuerBold: return "\u{f48f}"
        case .guestIssuerLight: return "\u{f490}"
        case .guestIssuerRegular: return "\u{f491}"
        case .guideBold: return "\u{f492}"
        case .guideLight: return "\u{f493}"
        case .guideRegular: return "\u{f494}"
        case .handlerBold: return "\u{f495}"
        case .handlerLight: return "\u{f496}"
        case .handlerRegular: return "\u{f497}"
        case .handsetAlertBold: return "\u{f498}"
        case .handsetAlertFilled: return "\u{f499}"
        case .handsetAlertLight: return "\u{f49a}"
        case .handsetAlertRegular: return "\u{f49b}"
        case .handsetBold: return "\u{f49c}"
        case .handsetFilled: return "\u{f49d}"
        case .handsetLight: return "\u{f49e}"
        case .handsetMutedBold: return "\u{f49f}"
        case .handsetMutedFilled: return "\u{f4a0}"
        case .handsetMutedLight: return "\u{f4a1}"
        case .handsetMutedRegular: return "\u{f4a2}"
        case .handsetRegular: return "\u{f4a3}"
        case .handshakeBold: return "\u{f4a4}"
        case .handshakeLight: return "\u{f4a5}"
        case .handshakeRegular: return "\u{f4a6}"
        case .headingOneBold: return "\u{f4a7}"
        case .headingOneLight: return "\u{f4a8}"
        case .headingOneRegular: return "\u{f4a9}"
        case .headingThreeBold: return "\u{f4aa}"
        case .headingThreeLight: return "\u{f4ab}"
        case .headingThreeRegular: return "\u{f4ac}"
        case .headingTwoBold: return "\u{f4ad}"
        case .headingTwoLight: return "\u{f4ae}"
        case .headingTwoRegular: return "\u{f4af}"
        case .headsetAlertBold: return "\u{f4b0}"
        case .headsetAlertLight: return "\u{f4b1}"
        case .headsetAlertRegular: return "\u{f4b2}"
        case .headsetBold: return "\u{f4b3}"
        case .headsetFilled: return "\u{f4b4}"
        case .headsetLight: return "\u{f4b5}"
        case .headsetMutedBold: return "\u{f4b6}"
        case .headsetMutedLight: return "\u{f4b7}"
        case .headsetMutedRegular: return "\u{f4b8}"
        case .headsetPrivateBold: return "\u{f4b9}"
        case .headsetPrivateLight: return "\u{f4ba}"
        case .headsetPrivateRegular: return "\u{f4bb}"
        case .headsetRegular: return "\u{f4bc}"
        case .helpBold: return "\u{f4bd}"
        case .helpCircleActiveFilled: return "\u{f4be}"
        case .helpCircleBold: return "\u{f4bf}"
        case .helpCircleLight: return "\u{f4c0}"
        case .helpCircleRegular: return "\u{f4c1}"
        case .helpLight: return "\u{f4c2}"
        case .helpRegular: return "\u{f4c3}"
        case .helpdeskBold: return "\u{f4c4}"
        case .helpdeskLight: return "\u{f4c5}"
        case .helpdeskRegular: return "\u{f4c6}"
        case .hideBold: return "\u{f4c7}"
        case .hideFilled: return "\u{f4c8}"
        case .hideLight: return "\u{f4c9}"
        case .hideRegular: return "\u{f4ca}"
        case .homeBold: return "\u{f4cb}"
        case .homeFilled: return "\u{f4cc}"
        case .homeLight: return "\u{f4cd}"
        case .homeRegular: return "\u{f4ce}"
        case .horizontalLineBold: return "\u{f4cf}"
        case .horizontalLineLight: return "\u{f4d0}"
        case .horizontalLineRegular: return "\u{f4d1}"
        case .humidityBold: return "\u{f4d2}"
        case .humidityLight: return "\u{f4d3}"
        case .humidityRegular: return "\u{f4d4}"
        case .huntGroupBold: return "\u{f4d5}"
        case .huntGroupFilled: return "\u{f4d6}"
        case .huntGroupLight: return "\u{f4d7}"
        case .huntGroupRegular: return "\u{f4d8}"
        case .importBold: return "\u{f4d9}"
        case .importLight: return "\u{f4da}"
        case .importRegular: return "\u{f4db}"
        case .incomingCallLegacyBold: return "\u{f4dc}"
        case .incomingCallLegacyLight: return "\u{f4dd}"
        case .incomingCallLegacyRegular: return "\u{f4de}"
        case .infoBadgeFilled: return "\u{f4df}"
        case .infoCircleBold: return "\u{f4e0}"
        case .infoCircleFilled: return "\u{f4e1}"
        case .infoCircleLight: return "\u{f4e2}"
        case .infoCircleRegular: return "\u{f4e3}"
        case .infoCircleTwoBold: return "\u{f4e4}"
        case .infoCircleTwoFilled: return "\u{f4e5}"
        case .infoCircleTwoLight: return "\u{f4e6}"
        case .infoCircleTwoRegular: return "\u{f4e7}"
        case .inputBold: return "\u{f4e8}"
        case .inputDisconnectedBold: return "\u{f4e9}"
        case .inputDisconnectedLight: return "\u{f4ea}"
        case .inputDisconnectedRegular: return "\u{f4eb}"
        case .inputLight: return "\u{f4ec}"
        case .inputRegular: return "\u{f4ed}"
        case .integrationsBold: return "\u{f4ee}"
        case .integrationsLight: return "\u{f4ef}"
        case .integrationsRegular: return "\u{f4f0}"
        case .invitedUserBold: return "\u{f4f1}"
        case .invitedUserLight: return "\u{f4f2}"
        case .invitedUserRegular: return "\u{f4f3}"
        case .italicBold: return "\u{f4f4}"
        case .italicLight: return "\u{f4f5}"
        case .italicRegular: return "\u{f4f6}"
        case .joinAudioBold: return "\u{f4f7}"
        case .joinAudioFilled: return "\u{f4f8}"
        case .joinAudioLight: return "\u{f4f9}"
        case .joinAudioRegular: return "\u{f4fa}"
        case .keyboardBold: return "\u{f4fb}"
        case .keyboardCloseBold: return "\u{f4fc}"
        case .keyboardCloseLight: return "\u{f4fd}"
        case .keyboardCloseRegular: return "\u{f4fe}"
        case .keyboardLight: return "\u{f4ff}"
        case .keyboardRegular: return "\u{f500}"
        case .languageBold: return "\u{f501}"
        case .languageLight: return "\u{f502}"
        case .languageRegular: return "\u{f503}"
        case .laptopBold: return "\u{f504}"
        case .laptopDisconnectedBold: return "\u{f505}"
        case .laptopDisconnectedLight: return "\u{f506}"
        case .laptopDisconnectedRegular: return "\u{f507}"
        case .laptopFilled: return "\u{f508}"
        case .laptopLight: return "\u{f509}"
        case .laptopRegular: return "\u{f50a}"
        case .laserPointerBold: return "\u{f50b}"
        case .laserPointerLight: return "\u{f50c}"
        case .laserPointerRegular: return "\u{f50d}"
        case .launchBold: return "\u{f50e}"
        case .launchLight: return "\u{f50f}"
        case .launchRegular: return "\u{f510}"
        case .layoutSideBySideVerticalBold: return "\u{f511}"
        case .layoutSideBySideVerticalFilled: return "\u{f512}"
        case .layoutSideBySideVerticalLight: return "\u{f513}"
        case .layoutSideBySideVerticalRegular: return "\u{f514}"
        case .leaveDeviceBold: return "\u{f515}"
        case .leaveDeviceLight: return "\u{f516}"
        case .leaveDeviceRegular: return "\u{f517}"
        case .likeBold: return "\u{f518}"
        case .likeFilled: return "\u{f519}"
        case .likeLight: return "\u{f51a}"
        case .likeRegular: return "\u{f51b}"
        case .linkBold: return "\u{f51c}"
        case .linkLight: return "\u{f51d}"
        case .linkRegular: return "\u{f51e}"
        case .listBulletedBold: return "\u{f51f}"
        case .listBulletedLight: return "\u{f520}"
        case .listBulletedRegular: return "\u{f521}"
        case .listMenuBold: return "\u{f522}"
        case .listMenuLight: return "\u{f523}"
        case .listMenuRegular: return "\u{f524}"
        case .listNumberedBold: return "\u{f525}"
        case .listNumberedLight: return "\u{f526}"
        case .listNumberedRegular: return "\u{f527}"
        case .locationBold: return "\u{f528}"
        case .locationFilled: return "\u{f529}"
        case .locationLight: return "\u{f52a}"
        case .locationRegular: return "\u{f52b}"
        case .lowerHandBold: return "\u{f52c}"
        case .lowerHandLight: return "\u{f52d}"
        case .lowerHandRegular: return "\u{f52e}"
        case .markAsUnreadBold: return "\u{f52f}"
        case .markAsUnreadLight: return "\u{f530}"
        case .markAsUnreadRegular: return "\u{f531}"
        case .markdownBold: return "\u{f532}"
        case .markdownLight: return "\u{f533}"
        case .markdownRegular: return "\u{f534}"
        case .markerBold: return "\u{f535}"
        case .markerFilled: return "\u{f536}"
        case .markerLight: return "\u{f537}"
        case .markerRegular: return "\u{f538}"
        case .maximizeBold: return "\u{f539}"
        case .maximizeLight: return "\u{f53a}"
        case .maximizeRegular: return "\u{f53b}"
        case .mediaPlayerBold: return "\u{f53c}"
        case .mediaPlayerLight: return "\u{f53d}"
        case .mediaPlayerRegular: return "\u{f53e}"
        case .mediaQualityGoodBold: return "\u{f53f}"
        case .mediaQualityGoodFilled: return "\u{f540}"
        case .mediaQualityGoodLight: return "\u{f541}"
        case .mediaQualityGoodRegular: return "\u{f542}"
        case .mediaQualityPoorBold: return "\u{f543}"
        case .mediaQualityPoorFilled: return "\u{f544}"
        case .mediaQualityPoorLight: return "\u{f545}"
        case .mediaQualityPoorRegular: return "\u{f546}"
        case .mediaQualityUnstableBold: return "\u{f547}"
        case .mediaQualityUnstableFilled: return "\u{f548}"
        case .mediaQualityUnstableLight: return "\u{f549}"
        case .mediaQualityUnstableRegular: return "\u{f54a}"
        case .meetBold: return "\u{f54b}"
        case .meetEndBold: return "\u{f54c}"
        case .meetEndLight: return "\u{f54d}"
        case .meetEndRegular: return "\u{f54e}"
        case .meetFilled: return "\u{f54f}"
        case .meetLight: return "\u{f550}"
        case .meetRegular: return "\u{f551}"
        case .meetingsBold: return "\u{f552}"
        case .meetingsFilled: return "\u{f553}"
        case .meetingsFocusMonthBold: return "\u{f554}"
        case .meetingsFocusMonthLight: return "\u{f555}"
        case .meetingsFocusMonthRegular: return "\u{f556}"
        case .meetingsFocusOneDayBold: return "\u{f557}"
        case .meetingsFocusOneDayLight: return "\u{f558}"
        case .meetingsFocusOneDayRegular: return "\u{f559}"
        case .meetingsFocusThreeDayBold: return "\u{f55a}"
        case .meetingsFocusThreeDayLight: return "\u{f55b}"
        case .meetingsFocusThreeDayRegular: return "\u{f55c}"
        case .meetingsFocusUpcomingBold: return "\u{f55d}"
        case .meetingsFocusUpcomingLight: return "\u{f55e}"
        case .meetingsFocusUpcomingRegular: return "\u{f55f}"
        case .meetingsFocusWeekBold: return "\u{f560}"
        case .meetingsFocusWeekLight: return "\u{f561}"
        case .meetingsFocusWeekRegular: return "\u{f562}"
        case .meetingsLight: return "\u{f563}"
        case .meetingsPresenceBold: return "\u{f564}"
        case .meetingsPresenceFilled: return "\u{f565}"
        case .meetingsPresenceLight: return "\u{f566}"
        case .meetingsPresenceRegular: return "\u{f567}"
        case .meetingsPresenceSmallFilled: return "\u{f568}"
        case .meetingsRegular: return "\u{f569}"
        case .meetingsTeamActiveBold: return "\u{f56a}"
        case .meetingsTeamActiveLight: return "\u{f56b}"
        case .meetingsTeamActiveRegular: return "\u{f56c}"
        case .meetingsTeamBold: return "\u{f56d}"
        case .meetingsTeamLight: return "\u{f56e}"
        case .meetingsTeamNewBold: return "\u{f56f}"
        case .meetingsTeamNewLight: return "\u{f570}"
        case .meetingsTeamNewRegular: return "\u{f571}"
        case .meetingsTeamRegular: return "\u{f572}"
        case .mentionBold: return "\u{f573}"
        case .mentionLight: return "\u{f574}"
        case .mentionRegular: return "\u{f575}"
        case .microphoneBold: return "\u{f576}"
        case .microphoneFilled: return "\u{f577}"
        case .microphoneHardMutedBold: return "\u{f578}"
        case .microphoneHardMutedColoredBold: return "\u{f579}"
        case .microphoneHardMutedColoredLight: return "\u{f57a}"
        case .microphoneHardMutedColoredRegular: return "\u{f57b}"
        case .microphoneHardMutedLight: return "\u{f57c}"
        case .microphoneHardMutedRegular: return "\u{f57d}"
        case .microphoneLight: return "\u{f57e}"
        case .microphoneMusicModeColoredBold: return "\u{f57f}"
        case .microphoneMusicModeColoredLight: return "\u{f580}"
        case .microphoneMusicModeColoredRegular: return "\u{f581}"
        case .microphoneMutedBold: return "\u{f582}"
        case .microphoneMutedFilled: return "\u{f583}"
        case .microphoneMutedIndicatorFilled: return "\u{f584}"
        case .microphoneMutedLight: return "\u{f585}"
        case .microphoneMutedRegular: return "\u{f586}"
        case .microphoneRegular: return "\u{f587}"
        case .minimizeBold: return "\u{f588}"
        case .minimizeLight: return "\u{f589}"
        case .minimizeRegular: return "\u{f58a}"
        case .minusBold: return "\u{f58b}"
        case .minusLight: return "\u{f58c}"
        case .minusRegular: return "\u{f58d}"
        case .mirrorBold: return "\u{f58e}"
        case .mirrorFilled: return "\u{f58f}"
        case .mirrorLight: return "\u{f590}"
        case .mirrorRegular: return "\u{f591}"
        case .moreAdrBold: return "\u{f592}"
        case .moreAdrLight: return "\u{f593}"
        case .moreAdrRegular: return "\u{f594}"
        case .moreBold: return "\u{f595}"
        case .moreCircleBold: return "\u{f596}"
        case .moreCircleFilled: return "\u{f597}"
        case .moreCircleLight: return "\u{f598}"
        case .moreCircleRegular: return "\u{f599}"
        case .moreLight: return "\u{f59a}"
        case .moreRegular: return "\u{f59b}"
        case .mouseCursorBold: return "\u{f59c}"
        case .mouseCursorLight: return "\u{f59d}"
        case .mouseCursorRegular: return "\u{f59e}"
        case .moveCallInAdrBold: return "\u{f59f}"
        case .moveCallInAdrLight: return "\u{f5a0}"
        case .moveCallInAdrRegular: return "\u{f5a1}"
        case .moveCallInIphBold: return "\u{f5a2}"
        case .moveCallInIphLight: return "\u{f5a3}"
        case .moveCallInIphRegular: return "\u{f5a4}"
        case .moveCallInLaptopBold: return "\u{f5a5}"
        case .moveCallInLaptopLight: return "\u{f5a6}"
        case .moveCallInLaptopRegular: return "\u{f5a7}"
        case .moveCallInOutAdrBold: return "\u{f5a8}"
        case .moveCallInOutAdrLight: return "\u{f5a9}"
        case .moveCallInOutAdrRegular: return "\u{f5aa}"
        case .moveCallInOutIphBold: return "\u{f5ab}"
        case .moveCallInOutIphLight: return "\u{f5ac}"
        case .moveCallInOutIphRegular: return "\u{f5ad}"
        case .moveCallInTabletBold: return "\u{f5ae}"
        case .moveCallInTabletLight: return "\u{f5af}"
        case .moveCallInTabletRegular: return "\u{f5b0}"
        case .moveCallOutAdrBold: return "\u{f5b1}"
        case .moveCallOutAdrLight: return "\u{f5b2}"
        case .moveCallOutAdrRegular: return "\u{f5b3}"
        case .moveCallOutIphBold: return "\u{f5b4}"
        case .moveCallOutIphLight: return "\u{f5b5}"
        case .moveCallOutIphRegular: return "\u{f5b6}"
        case .moveCallOutLaptopBold: return "\u{f5b7}"
        case .moveCallOutLaptopLight: return "\u{f5b8}"
        case .moveCallOutLaptopRegular: return "\u{f5b9}"
        case .moveCallOutTabletBold: return "\u{f5ba}"
        case .moveCallOutTabletLight: return "\u{f5bb}"
        case .moveCallOutTabletRegular: return "\u{f5bc}"
        case .multilineChartBold: return "\u{f5bd}"
        case .multilineChartFilled: return "\u{f5be}"
        case .multilineChartLight: return "\u{f5bf}"
        case .multilineChartRegular: return "\u{f5c0}"
        case .multimediaBold: return "\u{f5c1}"
        case .multimediaLight: return "\u{f5c2}"
        case .multimediaRegular: return "\u{f5c3}"
        case .multipledDevicesBold: return "\u{f5c4}"
        case .multipledDevicesLight: return "\u{f5c5}"
        case .multipledDevicesRegular: return "\u{f5c6}"
        case .musicModeBold: return "\u{f5c7}"
        case .musicModeCircleBold: return "\u{f5c8}"
        case .musicModeCircleFilled: return "\u{f5c9}"
        case .musicModeCircleLight: return "\u{f5ca}"
        case .musicModeCircleRegular: return "\u{f5cb}"
        case .musicModeFilled: return "\u{f5cc}"
        case .musicModeLight: return "\u{f5cd}"
        case .musicModeRegular: return "\u{f5ce}"
        case .muteOnEntryBold: return "\u{f5cf}"
        case .muteOnEntryFilled: return "\u{f5d0}"
        case .muteOnEntryLight: return "\u{f5d1}"
        case .muteOnEntryRegular: return "\u{f5d2}"
        case .newVoicemailBold: return "\u{f5d3}"
        case .newVoicemailLight: return "\u{f5d4}"
        case .newVoicemailRegular: return "\u{f5d5}"
        case .newWhiteboardBold: return "\u{f5d6}"
        case .newWhiteboardLight: return "\u{f5d7}"
        case .newWhiteboardRegular: return "\u{f5d8}"
        case .nextBold: return "\u{f5d9}"
        case .nextLight: return "\u{f5da}"
        case .nextRegular: return "\u{f5db}"
        case .noDevicesBold: return "\u{f5dc}"
        case .noDevicesLight: return "\u{f5dd}"
        case .noDevicesRegular: return "\u{f5de}"
        case .noiseRemovalBold: return "\u{f5df}"
        case .noiseRemovalLight: return "\u{f5e0}"
        case .noiseRemovalRegular: return "\u{f5e1}"
        case .noteBold: return "\u{f5e2}"
        case .noteLight: return "\u{f5e3}"
        case .notePptBold: return "\u{f5e4}"
        case .notePptLight: return "\u{f5e5}"
        case .notePptRegular: return "\u{f5e6}"
        case .noteRegular: return "\u{f5e7}"
        case .notesBold: return "\u{f5e8}"
        case .notesLight: return "\u{f5e9}"
        case .notesRegular: return "\u{f5ea}"
        case .numberBold: return "\u{f5eb}"
        case .numberLight: return "\u{f5ec}"
        case .numberRegular: return "\u{f5ed}"
        case .oldRemoteBold: return "\u{f5ee}"
        case .oldRemoteLight: return "\u{f5ef}"
        case .oldRemoteRegular: return "\u{f5f0}"
        case .oldTouchBold: return "\u{f5f1}"
        case .oldTouchLight: return "\u{f5f2}"
        case .oldTouchRegular: return "\u{f5f3}"
        case .openInFolderBold: return "\u{f5f4}"
        case .openInFolderLight: return "\u{f5f5}"
        case .openInFolderRegular: return "\u{f5f6}"
        case .openPagesBold: return "\u{f5f7}"
        case .openPagesLight: return "\u{f5f8}"
        case .openPagesRegular: return "\u{f5f9}"
        case .otherNumberBold: return "\u{f5fa}"
        case .otherNumberLight: return "\u{f5fb}"
        case .otherNumberRegular: return "\u{f5fc}"
        case .otherNumberWarningBold: return "\u{f5fd}"
        case .otherNumberWarningLight: return "\u{f5fe}"
        case .otherNumberWarningRegular: return "\u{f5ff}"
        case .outgoingCallLegacyBold: return "\u{f600}"
        case .outgoingCallLegacyLight: return "\u{f601}"
        case .outgoingCallLegacyRegular: return "\u{f602}"
        case .overflowLeftBold: return "\u{f603}"
        case .overflowLeftLight: return "\u{f604}"
        case .overflowLeftRegular: return "\u{f605}"
        case .overflowRightBold: return "\u{f606}"
        case .overflowRightLight: return "\u{f607}"
        case .overflowRightRegular: return "\u{f608}"
        case .pairedCameraBold: return "\u{f609}"
        case .pairedCameraLight: return "\u{f60a}"
        case .pairedCameraRegular: return "\u{f60b}"
        case .pairedDeviceBold: return "\u{f60c}"
        case .pairedDeviceLight: return "\u{f60d}"
        case .pairedDeviceRegular: return "\u{f60e}"
        case .pairedHandsetBold: return "\u{f60f}"
        case .pairedHandsetLight: return "\u{f610}"
        case .pairedHandsetRegular: return "\u{f611}"
        case .pairingBold: return "\u{f612}"
        case .pairingLight: return "\u{f613}"
        case .pairingRegular: return "\u{f614}"
        case .parkedBold: return "\u{f615}"
        case .parkedFilled: return "\u{f616}"
        case .parkedLight: return "\u{f617}"
        case .parkedRegular: return "\u{f618}"
        case .parseBold: return "\u{f619}"
        case .parseLight: return "\u{f61a}"
        case .parseRegular: return "\u{f61b}"
        case .participantAddBold: return "\u{f61c}"
        case .participantAddLight: return "\u{f61d}"
        case .participantAddRegular: return "\u{f61e}"
        case .participantBlockedBold: return "\u{f61f}"
        case .participantBlockedLight: return "\u{f620}"
        case .participantBlockedRegular: return "\u{f621}"
        case .participantBold: return "\u{f622}"
        case .participantFilled: return "\u{f623}"
        case .participantLight: return "\u{f624}"
        case .participantListBold: return "\u{f625}"
        case .participantListFilled: return "\u{f626}"
        case .participantListLight: return "\u{f627}"
        case .participantListRegular: return "\u{f628}"
        case .participantRegular: return "\u{f629}"
        case .participantRemoveBold: return "\u{f62a}"
        case .participantRemoveLight: return "\u{f62b}"
        case .participantRemoveRegular: return "\u{f62c}"
        case .participantUnknownBold: return "\u{f62d}"
        case .participantUnknownLight: return "\u{f62e}"
        case .participantUnknownRegular: return "\u{f62f}"
        case .passMouseBold: return "\u{f630}"
        case .passMouseLight: return "\u{f631}"
        case .passMouseRegular: return "\u{f632}"
        case .pauseBold: return "\u{f633}"
        case .pauseFilled: return "\u{f634}"
        case .pauseLight: return "\u{f635}"
        case .pauseRegular: return "\u{f636}"
        case .penBold: return "\u{f637}"
        case .penFilled: return "\u{f638}"
        case .penLight: return "\u{f639}"
        case .penRegular: return "\u{f63a}"
        case .peopleBold: return "\u{f63b}"
        case .peopleCircleBold: return "\u{f63c}"
        case .peopleCircleFilled: return "\u{f63d}"
        case .peopleCircleLight: return "\u{f63e}"
        case .peopleCircleRegular: return "\u{f63f}"
        case .peopleFilled: return "\u{f640}"
        case .peopleInsightsFilled: return "\u{f641}"
        case .peopleLight: return "\u{f642}"
        case .peopleRegular: return "\u{f643}"
        case .phoneAlertBold: return "\u{f644}"
        case .phoneAlertLight: return "\u{f645}"
        case .phoneAlertRegular: return "\u{f646}"
        case .phoneBold: return "\u{f647}"
        case .phoneFilled: return "\u{f648}"
        case .phoneLight: return "\u{f649}"
        case .phoneMutedBold: return "\u{f64a}"
        case .phoneMutedLight: return "\u{f64b}"
        case .phoneMutedRegular: return "\u{f64c}"
        case .phonePrivateBold: return "\u{f64d}"
        case .phonePrivateLight: return "\u{f64e}"
        case .phonePrivateRegular: return "\u{f64f}"
        case .phoneRegular: return "\u{f650}"
        case .phoneReplyAllBold: return "\u{f651}"
        case .phoneReplyAllLight: return "\u{f652}"
        case .phoneReplyAllRegular: return "\u{f653}"
        case .phoneReplyBold: return "\u{f654}"
        case .phoneReplyLight: return "\u{f655}"
        case .phoneReplyRegular: return "\u{f656}"
        case .pickerBold: return "\u{f657}"
        case .pickerLight: return "\u{f658}"
        case .pickerRegular: return "\u{f659}"
        case .pictureInPictureBold: return "\u{f65a}"
        case .pictureInPictureLight: return "\u{f65b}"
        case .pictureInPictureRegular: return "\u{f65c}"
        case .pieChartBold: return "\u{f65d}"
        case .pieChartFilled: return "\u{f65e}"
        case .pieChartLight: return "\u{f65f}"
        case .pieChartRegular: return "\u{f660}"
        case .pinBold: return "\u{f661}"
        case .pinFilled: return "\u{f662}"
        case .pinLight: return "\u{f663}"
        case .pinListBold: return "\u{f664}"
        case .pinListLight: return "\u{f665}"
        case .pinListRegular: return "\u{f666}"
        case .pinMutedBold: return "\u{f667}"
        case .pinMutedLight: return "\u{f668}"
        case .pinMutedRegular: return "\u{f669}"
        case .pinRegular: return "\u{f66a}"
        case .placeholderBold: return "\u{f66b}"
        case .placeholderLight: return "\u{f66c}"
        case .placeholderRegular: return "\u{f66d}"
        case .playBold: return "\u{f66e}"
        case .playFilled: return "\u{f66f}"
        case .playLight: return "\u{f670}"
        case .playRegular: return "\u{f671}"
        case .plugAcBold: return "\u{f672}"
        case .plugAcLight: return "\u{f673}"
        case .plugAcRegular: return "\u{f674}"
        case .plusBold: return "\u{f675}"
        case .plusCircleBold: return "\u{f676}"
        case .plusCircleFilled: return "\u{f677}"
        case .plusCircleLight: return "\u{f678}"
        case .plusCircleRegular: return "\u{f679}"
        case .plusLight: return "\u{f67a}"
        case .plusRegular: return "\u{f67b}"
        case .pmrBold: return "\u{f67c}"
        case .pmrFilled: return "\u{f67d}"
        case .pmrLight: return "\u{f67e}"
        case .pmrRegular: return "\u{f67f}"
        case .pollBold: return "\u{f680}"
        case .pollLight: return "\u{f681}"
        case .pollRegular: return "\u{f682}"
        case .popInBold: return "\u{f683}"
        case .popInLight: return "\u{f684}"
        case .popInRegular: return "\u{f685}"
        case .popOutBold: return "\u{f686}"
        case .popOutLight: return "\u{f687}"
        case .popOutRegular: return "\u{f688}"
        case .popUpBold: return "\u{f689}"
        case .popUpLight: return "\u{f68a}"
        case .popUpRegular: return "\u{f68b}"
        case .portraitLandscapeBold: return "\u{f68c}"
        case .portraitLandscapeLight: return "\u{f68d}"
        case .portraitLandscapeRegular: return "\u{f68e}"
        case .powerAcBold: return "\u{f68f}"
        case .powerAcLight: return "\u{f690}"
        case .powerAcRegular: return "\u{f691}"
        case .powerBold: return "\u{f692}"
        case .powerLight: return "\u{f693}"
        case .powerRegular: return "\u{f694}"
        case .presentationBold: return "\u{f695}"
        case .presentationLight: return "\u{f696}"
        case .presentationRegular: return "\u{f697}"
        case .printBold: return "\u{f698}"
        case .printLight: return "\u{f699}"
        case .printRegular: return "\u{f69a}"
        case .priorityBadgeFilled: return "\u{f69b}"
        case .priorityCircleBold: return "\u{f69c}"
        case .priorityCircleFilled: return "\u{f69d}"
        case .priorityCircleLight: return "\u{f69e}"
        case .priorityCircleRegular: return "\u{f69f}"
        case .priorityCircleTwoBold: return "\u{f6a0}"
        case .priorityCircleTwoFilled: return "\u{f6a1}"
        case .priorityCircleTwoLight: return "\u{f6a2}"
        case .priorityCircleTwoRegular: return "\u{f6a3}"
        case .privacyCircleBold: return "\u{f6a4}"
        case .privacyCircleFilled: return "\u{f6a5}"
        case .privacyCircleLight: return "\u{f6a6}"
        case .privacyCircleRegular: return "\u{f6a7}"
        case .privateBold: return "\u{f6a8}"
        case .privateCircleBold: return "\u{f6a9}"
        case .privateCircleFilled: return "\u{f6aa}"
        case .privateCircleLight: return "\u{f6ab}"
        case .privateCircleRegular: return "\u{f6ac}"
        case .privateLight: return "\u{f6ad}"
        case .privateMeetingBold: return "\u{f6ae}"
        case .privateMeetingLight: return "\u{f6af}"
        case .privateMeetingRegular: return "\u{f6b0}"
        case .privateRegular: return "\u{f6b1}"
        case .productDemoBold: return "\u{f6b2}"
        case .productDemoLight: return "\u{f6b3}"
        case .productDemoRegular: return "\u{f6b4}"
        case .proximityBold: return "\u{f6b5}"
        case .proximityLight: return "\u{f6b6}"
        case .proximityMutedBold: return "\u{f6b7}"
        case .proximityMutedLight: return "\u{f6b8}"
        case .proximityMutedRegular: return "\u{f6b9}"
        case .proximityRegular: return "\u{f6ba}"
        case .proximityVideoBold: return "\u{f6bb}"
        case .proximityVideoLight: return "\u{f6bc}"
        case .proximityVideoRegular: return "\u{f6bd}"
        case .ptoPresenceBold: return "\u{f6be}"
        case .ptoPresenceFilled: return "\u{f6bf}"
        case .ptoPresenceLight: return "\u{f6c0}"
        case .ptoPresenceRegular: return "\u{f6c1}"
        case .pullCallBold: return "\u{f6c2}"
        case .pullCallLight: return "\u{f6c3}"
        case .pullCallRegular: return "\u{f6c4}"
        case .qABold: return "\u{f6c5}"
        case .qALight: return "\u{f6c6}"
        case .qARegular: return "\u{f6c7}"
        case .qualityBold: return "\u{f6c8}"
        case .qualityLight: return "\u{f6c9}"
        case .qualityRegular: return "\u{f6ca}"
        case .queueContactBold: return "\u{f6cb}"
        case .queueContactLight: return "\u{f6cc}"
        case .queueContactRegular: return "\u{f6cd}"
        case .quietBold: return "\u{f6ce}"
        case .quietHoursPresenceBold: return "\u{f6cf}"
        case .quietHoursPresenceFilled: return "\u{f6d0}"
        case .quietHoursPresenceLight: return "\u{f6d1}"
        case .quietHoursPresenceRegular: return "\u{f6d2}"
        case .quietLight: return "\u{f6d3}"
        case .quietRegular: return "\u{f6d4}"
        case .raiseHandBold: return "\u{f6d5}"
        case .raiseHandLight: return "\u{f6d6}"
        case .raiseHandRegular: return "\u{f6d7}"
        case .ramBold: return "\u{f6d8}"
        case .ramLight: return "\u{f6d9}"
        case .ramRegular: return "\u{f6da}"
        case .reactionsBold: return "\u{f6db}"
        case .reactionsFilled: return "\u{f6dc}"
        case .reactionsLight: return "\u{f6dd}"
        case .reactionsRegular: return "\u{f6de}"
        case .reactivateBold: return "\u{f6df}"
        case .reactivateLight: return "\u{f6e0}"
        case .reactivateRegular: return "\u{f6e1}"
        case .recentsBold: return "\u{f6e2}"
        case .recentsFilled: return "\u{f6e3}"
        case .recentsLight: return "\u{f6e4}"
        case .recentsPresenceBold: return "\u{f6e5}"
        case .recentsPresenceFilled: return "\u{f6e6}"
        case .recentsPresenceLight: return "\u{f6e7}"
        case .recentsPresenceRegular: return "\u{f6e8}"
        case .recentsPresenceSmallFilled: return "\u{f6e9}"
        case .recentsRegular: return "\u{f6ea}"
        case .recordBold: return "\u{f6eb}"
        case .recordFilled: return "\u{f6ec}"
        case .recordLight: return "\u{f6ed}"
        case .recordPausedBold: return "\u{f6ee}"
        case .recordPausedFilled: return "\u{f6ef}"
        case .recordPausedLight: return "\u{f6f0}"
        case .recordPausedRegular: return "\u{f6f1}"
        case .recordRegular: return "\u{f6f2}"
        case .recurringBold: return "\u{f6f3}"
        case .recurringLight: return "\u{f6f4}"
        case .recurringOffBold: return "\u{f6f5}"
        case .recurringOffLight: return "\u{f6f6}"
        case .recurringOffRegular: return "\u{f6f7}"
        case .recurringRegular: return "\u{f6f8}"
        case .redialBold: return "\u{f6f9}"
        case .redialLight: return "\u{f6fa}"
        case .redialRegular: return "\u{f6fb}"
        case .redoBold: return "\u{f6fc}"
        case .redoLight: return "\u{f6fd}"
        case .redoRegular: return "\u{f6fe}"
        case .refreshBold: return "\u{f6ff}"
        case .refreshLight: return "\u{f700}"
        case .refreshRegular: return "\u{f701}"
        case .remoteDesktopControlBold: return "\u{f702}"
        case .remoteDesktopControlFilled: return "\u{f703}"
        case .remoteDesktopControlLight: return "\u{f704}"
        case .remoteDesktopControlRegular: return "\u{f705}"
        case .removeBold: return "\u{f706}"
        case .removeFilled: return "\u{f707}"
        case .removeLight: return "\u{f708}"
        case .removeRegular: return "\u{f709}"
        case .replyBold: return "\u{f70a}"
        case .replyFilled: return "\u{f70b}"
        case .replyLight: return "\u{f70c}"
        case .replyListBold: return "\u{f70d}"
        case .replyListLight: return "\u{f70e}"
        case .replyListRegular: return "\u{f70f}"
        case .replyRegular: return "\u{f710}"
        case .resetBold: return "\u{f711}"
        case .resetLight: return "\u{f712}"
        case .resetRegular: return "\u{f713}"
        case .responsiveMobileBold: return "\u{f714}"
        case .responsiveMobileLight: return "\u{f715}"
        case .responsiveMobileRegular: return "\u{f716}"
        case .restartBold: return "\u{f717}"
        case .restartLight: return "\u{f718}"
        case .restartRegular: return "\u{f719}"
        case .returnBold: return "\u{f71a}"
        case .returnLight: return "\u{f71b}"
        case .returnRegular: return "\u{f71c}"
        case .ringtoneBold: return "\u{f71d}"
        case .ringtoneLight: return "\u{f71e}"
        case .ringtoneRegular: return "\u{f71f}"
        case .roomCalendarBold: return "\u{f720}"
        case .roomCalendarLight: return "\u{f721}"
        case .roomCalendarRegular: return "\u{f722}"
        case .roomLightsBold: return "\u{f723}"
        case .roomLightsLight: return "\u{f724}"
        case .roomLightsRegular: return "\u{f725}"
        case .rotateContentBold: return "\u{f726}"
        case .rotateContentFilled: return "\u{f727}"
        case .rotateContentLight: return "\u{f728}"
        case .rotateContentRegular: return "\u{f729}"
        case .runningApplicationBold: return "\u{f72a}"
        case .runningApplicationFilled: return "\u{f72b}"
        case .runningApplicationLight: return "\u{f72c}"
        case .runningApplicationRegular: return "\u{f72d}"
        case .saveBold: return "\u{f72e}"
        case .saveLight: return "\u{f72f}"
        case .saveRegular: return "\u{f730}"
        case .scanBold: return "\u{f731}"
        case .scanLight: return "\u{f732}"
        case .scanRegular: return "\u{f733}"
        case .schedulerAvailableBold: return "\u{f734}"
        case .schedulerAvailableLight: return "\u{f735}"
        case .schedulerAvailableRegular: return "\u{f736}"
        case .schedulerNotWorkingHoursBold: return "\u{f737}"
        case .schedulerNotWorkingHoursLight: return "\u{f738}"
        case .schedulerNotWorkingHoursRegular: return "\u{f739}"
        case .schedulerUnavailableBold: return "\u{f73a}"
        case .schedulerUnavailableLight: return "\u{f73b}"
        case .schedulerUnavailableRegular: return "\u{f73c}"
        case .schedulerUnknownBold: return "\u{f73d}"
        case .schedulerUnknownLight: return "\u{f73e}"
        case .schedulerUnknownRegular: return "\u{f73f}"
        case .screenshotBold: return "\u{f740}"
        case .screenshotDocBold: return "\u{f741}"
        case .screenshotDocFilled: return "\u{f742}"
        case .screenshotDocLight: return "\u{f743}"
        case .screenshotDocRegular: return "\u{f744}"
        case .screenshotLight: return "\u{f745}"
        case .screenshotRegular: return "\u{f746}"
        case .searchBold: return "\u{f747}"
        case .searchLight: return "\u{f748}"
        case .searchRegular: return "\u{f749}"
        case .secondaryArrowBold: return "\u{f74a}"
        case .secondaryArrowLight: return "\u{f74b}"
        case .secondaryArrowRegular: return "\u{f74c}"
        case .secureCallLockBold: return "\u{f74d}"
        case .secureCallLockFilled: return "\u{f74e}"
        case .secureCallLockLight: return "\u{f74f}"
        case .secureCallLockRegular: return "\u{f750}"
        case .secureCallShieldBold: return "\u{f751}"
        case .secureCallShieldFilled: return "\u{f752}"
        case .secureCallShieldLight: return "\u{f753}"
        case .secureCallShieldRegular: return "\u{f754}"
        case .secureCircleBold: return "\u{f755}"
        case .secureCircleFilled: return "\u{f756}"
        case .secureCircleLight: return "\u{f757}"
        case .secureCircleRegular: return "\u{f758}"
        case .secureLockBold: return "\u{f759}"
        case .secureLockFilled: return "\u{f75a}"
        case .secureLockLight: return "\u{f75b}"
        case .secureLockRegular: return "\u{f75c}"
        case .selectAllBold: return "\u{f75d}"
        case .selectAllFilled: return "\u{f75e}"
        case .selectAllLight: return "\u{f75f}"
        case .selectAllRegular: return "\u{f760}"
        case .selectionBold: return "\u{f761}"
        case .selectionLight: return "\u{f762}"
        case .selectionRegular: return "\u{f763}"
        case .sendBold: return "\u{f764}"
        case .sendFilled: return "\u{f765}"
        case .sendLight: return "\u{f766}"
        case .sendRegular: return "\u{f767}"
        case .serverBold: return "\u{f768}"
        case .serverErrorBold: return "\u{f769}"
        case .serverErrorLight: return "\u{f76a}"
        case .serverErrorRegular: return "\u{f76b}"
        case .serverLight: return "\u{f76c}"
        case .serverRegular: return "\u{f76d}"
        case .servicesBold: return "\u{f76e}"
        case .servicesLight: return "\u{f76f}"
        case .servicesRegular: return "\u{f770}"
        case .setVariableBold: return "\u{f771}"
        case .setVariableLight: return "\u{f772}"
        case .setVariableRegular: return "\u{f773}"
        case .settingsBold: return "\u{f774}"
        case .settingsFilled: return "\u{f775}"
        case .settingsLight: return "\u{f776}"
        case .settingsRegular: return "\u{f777}"
        case .setupAssistantBold: return "\u{f778}"
        case .setupAssistantLight: return "\u{f779}"
        case .setupAssistantRegular: return "\u{f77a}"
        case .shapeDiagonalLineBold: return "\u{f77b}"
        case .shapeDiagonalLineLight: return "\u{f77c}"
        case .shapeDiagonalLineRegular: return "\u{f77d}"
        case .shapeOvalBold: return "\u{f77e}"
        case .shapeOvalLight: return "\u{f77f}"
        case .shapeOvalRegular: return "\u{f780}"
        case .shapesBold: return "\u{f781}"
        case .shapesLight: return "\u{f782}"
        case .shapesRegular: return "\u{f783}"
        case .shareCNativeAdrBold: return "\u{f784}"
        case .shareCNativeAdrLight: return "\u{f785}"
        case .shareCNativeAdrRegular: return "\u{f786}"
        case .shareCNativeIphBold: return "\u{f787}"
        case .shareCNativeIphLight: return "\u{f788}"
        case .shareCNativeIphRegular: return "\u{f789}"
        case .shareScreenBold: return "\u{f78a}"
        case .shareScreenFilled: return "\u{f78b}"
        case .shareScreenLight: return "\u{f78c}"
        case .shareScreenRegular: return "\u{f78d}"
        case .shareScreenSmallFilled: return "\u{f78e}"
        case .shareSpaceBold: return "\u{f78f}"
        case .shareSpaceLight: return "\u{f790}"
        case .shareSpaceRegular: return "\u{f791}"
        case .shieldBold: return "\u{f792}"
        case .shieldLight: return "\u{f793}"
        case .shieldRegular: return "\u{f794}"
        case .showBold: return "\u{f795}"
        case .showFilled: return "\u{f796}"
        case .showLight: return "\u{f797}"
        case .showRegular: return "\u{f798}"
        case .signInBold: return "\u{f799}"
        case .signInForcedBold: return "\u{f79a}"
        case .signInForcedLight: return "\u{f79b}"
        case .signInForcedRegular: return "\u{f79c}"
        case .signInLight: return "\u{f79d}"
        case .signInRegular: return "\u{f79e}"
        case .signOutBold: return "\u{f79f}"
        case .signOutLight: return "\u{f7a0}"
        case .signOutRegular: return "\u{f7a1}"
        case .signal0Bold: return "\u{f7a2}"
        case .signal0Light: return "\u{f7a3}"
        case .signal0Regular: return "\u{f7a4}"
        case .signal100Bold: return "\u{f7a5}"
        case .signal100Light: return "\u{f7a6}"
        case .signal100Regular: return "\u{f7a7}"
        case .signal25Bold: return "\u{f7a8}"
        case .signal25Light: return "\u{f7a9}"
        case .signal25Regular: return "\u{f7aa}"
        case .signal50Bold: return "\u{f7ab}"
        case .signal50Light: return "\u{f7ac}"
        case .signal50Regular: return "\u{f7ad}"
        case .signal75Bold: return "\u{f7ae}"
        case .signal75Light: return "\u{f7af}"
        case .signal75Regular: return "\u{f7b0}"
        case .singleNumberReachBold: return "\u{f7b1}"
        case .singleNumberReachLight: return "\u{f7b2}"
        case .singleNumberReachRegular: return "\u{f7b3}"
        case .sipRegistrationInProgressBold: return "\u{f7b4}"
        case .sipRegistrationInProgressFilled: return "\u{f7b5}"
        case .sipRegistrationInProgressLight: return "\u{f7b6}"
        case .sipRegistrationInProgressRegular: return "\u{f7b7}"
        case .skipBold: return "\u{f7b8}"
        case .skipBwBold: return "\u{f7b9}"
        case .skipBwFilled: return "\u{f7ba}"
        case .skipBwLight: return "\u{f7bb}"
        case .skipBwRegular: return "\u{f7bc}"
        case .skipFwBold: return "\u{f7bd}"
        case .skipFwFilled: return "\u{f7be}"
        case .skipFwLight: return "\u{f7bf}"
        case .skipFwRegular: return "\u{f7c0}"
        case .skipLight: return "\u{f7c1}"
        case .skipRegular: return "\u{f7c2}"
        case .speakerBold: return "\u{f7c3}"
        case .speakerDisconnectedBold: return "\u{f7c4}"
        case .speakerDisconnectedFilled: return "\u{f7c5}"
        case .speakerDisconnectedLight: return "\u{f7c6}"
        case .speakerDisconnectedRegular: return "\u{f7c7}"
        case .speakerFilled: return "\u{f7c8}"
        case .speakerLight: return "\u{f7c9}"
        case .speakerMutedBold: return "\u{f7ca}"
        case .speakerMutedFilled: return "\u{f7cb}"
        case .speakerMutedLight: return "\u{f7cc}"
        case .speakerMutedRegular: return "\u{f7cd}"
        case .speakerOffBold: return "\u{f7ce}"
        case .speakerOffFilled: return "\u{f7cf}"
        case .speakerOffLight: return "\u{f7d0}"
        case .speakerOffRegular: return "\u{f7d1}"
        case .speakerOnColoredBold: return "\u{f7d2}"
        case .speakerOnColoredLight: return "\u{f7d3}"
        case .speakerOnColoredRegular: return "\u{f7d4}"
        case .speakerRegular: return "\u{f7d5}"
        case .speakerTurnDownBold: return "\u{f7d6}"
        case .speakerTurnDownFilled: return "\u{f7d7}"
        case .speakerTurnDownLight: return "\u{f7d8}"
        case .speakerTurnDownRegular: return "\u{f7d9}"
        case .speakerTurnUpBold: return "\u{f7da}"
        case .speakerTurnUpFilled: return "\u{f7db}"
        case .speakerTurnUpLight: return "\u{f7dc}"
        case .speakerTurnUpRegular: return "\u{f7dd}"
        case .spinnerBold: return "\u{f7de}"
        case .spinnerFilledBold: return "\u{f7df}"
        case .spinnerFilledLight: return "\u{f7e0}"
        case .spinnerFilledRegular: return "\u{f7e1}"
        case .spinnerLight: return "\u{f7e2}"
        case .spinnerRegular: return "\u{f7e3}"
        case .stackedArea100ChartBold: return "\u{f7e4}"
        case .stackedArea100ChartFilled: return "\u{f7e5}"
        case .stackedArea100ChartLight: return "\u{f7e6}"
        case .stackedArea100ChartRegular: return "\u{f7e7}"
        case .stackedAreaChartBold: return "\u{f7e8}"
        case .stackedAreaChartFilled: return "\u{f7e9}"
        case .stackedAreaChartLight: return "\u{f7ea}"
        case .stackedAreaChartRegular: return "\u{f7eb}"
        case .stackedBar100ChartBold: return "\u{f7ec}"
        case .stackedBar100ChartFilled: return "\u{f7ed}"
        case .stackedBar100ChartLight: return "\u{f7ee}"
        case .stackedBar100ChartRegular: return "\u{f7ef}"
        case .stackedBarChartBold: return "\u{f7f0}"
        case .stackedBarChartFilled: return "\u{f7f1}"
        case .stackedBarChartLight: return "\u{f7f2}"
        case .stackedBarChartRegular: return "\u{f7f3}"
        case .startChatBold: return "\u{f7f4}"
        case .startChatLight: return "\u{f7f5}"
        case .startChatRegular: return "\u{f7f6}"
        case .stickersBold: return "\u{f7f7}"
        case .stickersLight: return "\u{f7f8}"
        case .stickersRegular: return "\u{f7f9}"
        case .stickiesBold: return "\u{f7fa}"
        case .stickiesLight: return "\u{f7fb}"
        case .stickiesRegular: return "\u{f7fc}"
        case .stopBold: return "\u{f7fd}"
        case .stopCircleBold: return "\u{f7fe}"
        case .stopCircleFilled: return "\u{f7ff}"
        case .stopCircleLight: return "\u{f800}"
        case .stopCircleRegular: return "\u{f801}"
        case .stopContentShareBold: return "\u{f802}"
        case .stopContentShareLight: return "\u{f803}"
        case .stopContentShareRegular: return "\u{f804}"
        case .stopFilled: return "\u{f805}"
        case .stopLight: return "\u{f806}"
        case .stopRegular: return "\u{f807}"
        case .storedInfoBold: return "\u{f808}"
        case .storedInfoFilled: return "\u{f809}"
        case .storedInfoLight: return "\u{f80a}"
        case .storedInfoRegular: return "\u{f80b}"
        case .streamingBold: return "\u{f80c}"
        case .streamingLight: return "\u{f80d}"
        case .streamingRegular: return "\u{f80e}"
        case .strikethroughBold: return "\u{f80f}"
        case .strikethroughLight: return "\u{f810}"
        case .strikethroughRegular: return "\u{f811}"
        case .subscriptBold: return "\u{f812}"
        case .subscriptLight: return "\u{f813}"
        case .subscriptRegular: return "\u{f814}"
        case .superscriptBold: return "\u{f815}"
        case .superscriptLight: return "\u{f816}"
        case .superscriptRegular: return "\u{f817}"
        case .sx10Bold: return "\u{f818}"
        case .sx10Light: return "\u{f819}"
        case .sx10Regular: return "\u{f81a}"
        case .sx20Bold: return "\u{f81b}"
        case .sx20Light: return "\u{f81c}"
        case .sx20Regular: return "\u{f81d}"
        case .sx80CodecBold: return "\u{f81e}"
        case .sx80CodecLight: return "\u{f81f}"
        case .sx80CodecRegular: return "\u{f820}"
        case .tableBold: return "\u{f821}"
        case .tableLight: return "\u{f822}"
        case .tableRegular: return "\u{f823}"
        case .tabletBold: return "\u{f824}"
        case .tabletLight: return "\u{f825}"
        case .tabletRegular: return "\u{f826}"
        case .tabsBold: return "\u{f827}"
        case .tabsLight: return "\u{f828}"
        case .tabsRegular: return "\u{f829}"
        case .tagBold: return "\u{f82a}"
        case .tagLight: return "\u{f82b}"
        case .tagRegular: return "\u{f82c}"
        case .telepresenceAlertBold: return "\u{f82d}"
        case .telepresenceAlertLight: return "\u{f82e}"
        case .telepresenceAlertMutedBold: return "\u{f82f}"
        case .telepresenceAlertMutedLight: return "\u{f830}"
        case .telepresenceAlertMutedRegular: return "\u{f831}"
        case .telepresenceAlertRegular: return "\u{f832}"
        case .telepresenceBold: return "\u{f833}"
        case .telepresenceIx5000Bold: return "\u{f834}"
        case .telepresenceIx5000Light: return "\u{f835}"
        case .telepresenceIx5000Regular: return "\u{f836}"
        case .telepresenceLight: return "\u{f837}"
        case .telepresencePrivateBold: return "\u{f838}"
        case .telepresencePrivateLight: return "\u{f839}"
        case .telepresencePrivateRegular: return "\u{f83a}"
        case .telepresenceRegular: return "\u{f83b}"
        case .temperatureBold: return "\u{f83c}"
        case .temperatureLight: return "\u{f83d}"
        case .temperatureRegular: return "\u{f83e}"
        case .textBold: return "\u{f83f}"
        case .textCodeBlockBold: return "\u{f840}"
        case .textCodeBlockLight: return "\u{f841}"
        case .textCodeBlockRegular: return "\u{f842}"
        case .textHighlightBold: return "\u{f843}"
        case .textHighlightLight: return "\u{f844}"
        case .textHighlightRegular: return "\u{f845}"
        case .textLight: return "\u{f846}"
        case .textRegular: return "\u{f847}"
        case .threeDObjectBold: return "\u{f848}"
        case .threeDObjectLight: return "\u{f849}"
        case .threeDObjectRegular: return "\u{f84a}"
        case .tooFastBold: return "\u{f84b}"
        case .tooFastLight: return "\u{f84c}"
        case .tooFastRegular: return "\u{f84d}"
        case .tooSlowBold: return "\u{f84e}"
        case .tooSlowLight: return "\u{f84f}"
        case .tooSlowRegular: return "\u{f850}"
        case .toolsBold: return "\u{f851}"
        case .toolsLight: return "\u{f852}"
        case .toolsRegular: return "\u{f853}"
        case .touch10Bold: return "\u{f854}"
        case .touch10Light: return "\u{f855}"
        case .touch10Regular: return "\u{f856}"
        case .transcriptBold: return "\u{f857}"
        case .transcriptLight: return "\u{f858}"
        case .transcriptRegular: return "\u{f859}"
        case .ucmCloudBold: return "\u{f85a}"
        case .ucmCloudLight: return "\u{f85b}"
        case .ucmCloudRegular: return "\u{f85c}"
        case .underlineBold: return "\u{f85d}"
        case .underlineLight: return "\u{f85e}"
        case .underlineRegular: return "\u{f85f}"
        case .undoBold: return "\u{f860}"
        case .undoLight: return "\u{f861}"
        case .undoRegular: return "\u{f862}"
        case .unlinkBold: return "\u{f863}"
        case .unlinkLight: return "\u{f864}"
        case .unlinkRegular: return "\u{f865}"
        case .unreadBold: return "\u{f866}"
        case .unreadFilled: return "\u{f867}"
        case .unreadLight: return "\u{f868}"
        case .unreadRegular: return "\u{f869}"
        case .unsecureUnlockedBold: return "\u{f86a}"
        case .unsecureUnlockedFilled: return "\u{f86b}"
        case .unsecureUnlockedLight: return "\u{f86c}"
        case .unsecureUnlockedRegular: return "\u{f86d}"
        case .unsortedBold: return "\u{f86e}"
        case .unsortedLight: return "\u{f86f}"
        case .unsortedRegular: return "\u{f870}"
        case .updateFileShareBold: return "\u{f871}"
        case .updateFileShareLight: return "\u{f872}"
        case .updateFileShareRegular: return "\u{f873}"
        case .uploadBold: return "\u{f874}"
        case .uploadLight: return "\u{f875}"
        case .uploadRegular: return "\u{f876}"
        case .usbBold: return "\u{f877}"
        case .usbHeadsetBold: return "\u{f878}"
        case .usbHeadsetLight: return "\u{f879}"
        case .usbHeadsetMutedBold: return "\u{f87a}"
        case .usbHeadsetMutedLight: return "\u{f87b}"
        case .usbHeadsetMutedRegular: return "\u{f87c}"
        case .usbHeadsetRegular: return "\u{f87d}"
        case .usbLight: return "\u{f87e}"
        case .usbRegular: return "\u{f87f}"
        case .userBold: return "\u{f880}"
        case .userLight: return "\u{f881}"
        case .userRegular: return "\u{f882}"
        case .vcsBold: return "\u{f883}"
        case .vcsLight: return "\u{f884}"
        case .vcsRegular: return "\u{f885}"
        case .videoBlurBold: return "\u{f886}"
        case .videoBlurFilled: return "\u{f887}"
        case .videoBlurLight: return "\u{f888}"
        case .videoBlurRegular: return "\u{f889}"
        case .videoBold: return "\u{f88a}"
        case .videoEffectBold: return "\u{f88b}"
        case .videoEffectFilled: return "\u{f88c}"
        case .videoEffectLight: return "\u{f88d}"
        case .videoEffectRegular: return "\u{f88e}"
        case .videoFilled: return "\u{f88f}"
        case .videoLayoutBold: return "\u{f890}"
        case .videoLayoutEqualBold: return "\u{f891}"
        case .videoLayoutEqualDualBold: return "\u{f892}"
        case .videoLayoutEqualDualLight: return "\u{f893}"
        case .videoLayoutEqualDualRegular: return "\u{f894}"
        case .videoLayoutEqualFilled: return "\u{f895}"
        case .videoLayoutEqualLight: return "\u{f896}"
        case .videoLayoutEqualRegular: return "\u{f897}"
        case .videoLayoutLight: return "\u{f898}"
        case .videoLayoutOverlayBold: return "\u{f899}"
        case .videoLayoutOverlayLight: return "\u{f89a}"
        case .videoLayoutOverlayRegular: return "\u{f89b}"
        case .videoLayoutProminentBold: return "\u{f89c}"
        case .videoLayoutProminentLight: return "\u{f89d}"
        case .videoLayoutProminentRegular: return "\u{f89e}"
        case .videoLayoutRegular: return "\u{f89f}"
        case .videoLayoutShareDominantBold: return "\u{f8a0}"
        case .videoLayoutShareDominantLight: return "\u{f8a1}"
        case .videoLayoutShareDominantRegular: return "\u{f8a2}"
        case .videoLayoutSingleBold: return "\u{f8a3}"
        case .videoLayoutSingleLight: return "\u{f8a4}"
        case .videoLayoutSingleRegular: return "\u{f8a5}"
        case .videoLayoutStackBold: return "\u{f8a6}"
        case .videoLayoutStackFilled: return "\u{f8a7}"
        case .videoLayoutStackLight: return "\u{f8a8}"
        case .videoLayoutStackRegular: return "\u{f8a9}"
        case .videoLayoutVideoDominantBold: return "\u{f8aa}"
        case .videoLayoutVideoDominantLight: return "\u{f8ab}"
        case .videoLayoutVideoDominantRegular: return "\u{f8ac}"
        case .videoLight: return "\u{f8ad}"
        case .videoPlusBold: return "\u{f8ae}"
        case .videoPlusFilled: return "\u{f8af}"
        case .videoPlusLight: return "\u{f8b0}"
        case .videoPlusRegular: return "\u{f8b1}"
        case .videoRegular: return "\u{f8b2}"
        case .videoSpeakerTrackBold: return "\u{f8b3}"
        case .videoSpeakerTrackFilled: return "\u{f8b4}"
        case .videoSpeakerTrackLight: return "\u{f8b5}"
        case .videoSpeakerTrackRegular: return "\u{f8b6}"
        case .viewAllBold: return "\u{f8b7}"
        case .viewAllLight: return "\u{f8b8}"
        case .viewAllRegular: return "\u{f8b9}"
        case .viewListBold: return "\u{f8ba}"
        case .viewListLight: return "\u{f8bb}"
        case .viewListRegular: return "\u{f8bc}"
        case .viewStackedBold: return "\u{f8bd}"
        case .viewStackedLight: return "\u{f8be}"
        case .viewStackedRegular: return "\u{f8bf}"
        case .viewThumbnailBold: return "\u{f8c0}"
        case .viewThumbnailLight: return "\u{f8c1}"
        case .viewThumbnailRegular: return "\u{f8c2}"
        case .voicemailBold: return "\u{f8c3}"
        case .voicemailFilled: return "\u{f8c4}"
        case .voicemailLight: return "\u{f8c5}"
        case .voicemailRegular: return "\u{f8c6}"
        case .wallpaperBold: return "\u{f8c7}"
        case .wallpaperLight: return "\u{f8c8}"
        case .wallpaperRegular: return "\u{f8c9}"
        case .warningBold: return "\u{f8ca}"
        case .warningFilled: return "\u{f8cb}"
        case .warningLight: return "\u{f8cc}"
        case .warningRegular: return "\u{f8cd}"
        case .webexBoardBold: return "\u{f8ce}"
        case .webexBoardLight: return "\u{f8cf}"
        case .webexBoardRegular: return "\u{f8d0}"
        case .webexCodecPlusBold: return "\u{f8d1}"
        case .webexCodecPlusLight: return "\u{f8d2}"
        case .webexCodecPlusRegular: return "\u{f8d3}"
        case .webexDeskCameraBold: return "\u{f8d4}"
        case .webexDeskCameraLight: return "\u{f8d5}"
        case .webexDeskCameraRegular: return "\u{f8d6}"
        case .webexHelixFilled: return "\u{f8d7}"
        case .webexMeetingsBold: return "\u{f8d8}"
        case .webexMeetingsFilled: return "\u{f8d9}"
        case .webexMeetingsLight: return "\u{f8da}"
        case .webexMeetingsRegular: return "\u{f8db}"
        case .webexQuadCameraBold: return "\u{f8dc}"
        case .webexQuadCameraLight: return "\u{f8dd}"
        case .webexQuadCameraRegular: return "\u{f8de}"
        case .webexRoomKitBold: return "\u{f8df}"
        case .webexRoomKitLight: return "\u{f8e0}"
        case .webexRoomKitPlusBold: return "\u{f8e1}"
        case .webexRoomKitPlusLight: return "\u{f8e2}"
        case .webexRoomKitPlusRegular: return "\u{f8e3}"
        case .webexRoomKitRegular: return "\u{f8e4}"
        case .webexShareBold: return "\u{f8e5}"
        case .webexShareLight: return "\u{f8e6}"
        case .webexShareRegular: return "\u{f8e7}"
        case .webexTeamsBold: return "\u{f8e8}"
        case .webexTeamsFilled: return "\u{f8e9}"
        case .webexTeamsLight: return "\u{f8ea}"
        case .webexTeamsNewBold: return "\u{f8eb}"
        case .webexTeamsNewFilled: return "\u{f8ec}"
        case .webexTeamsNewLight: return "\u{f8ed}"
        case .webexTeamsNewRegular: return "\u{f8ee}"
        case .webexTeamsRegular: return "\u{f8ef}"
        case .whiteboardBold: return "\u{f8f0}"
        case .whiteboardContentBold: return "\u{f8f1}"
        case .whiteboardContentLight: return "\u{f8f2}"
        case .whiteboardContentRegular: return "\u{f8f3}"
        case .whiteboardFilled: return "\u{f8f4}"
        case .whiteboardLight: return "\u{f8f5}"
        case .whiteboardRegular: return "\u{f8f6}"
        case .widgetBold: return "\u{f8f7}"
        case .widgetFilled: return "\u{f8f8}"
        case .widgetLight: return "\u{f8f9}"
        case .widgetRegular: return "\u{f8fa}"
        case .wifiBold: return "\u{f8fb}"
        case .wifiErrorBold: return "\u{f8fc}"
        case .wifiErrorLight: return "\u{f8fd}"
        case .wifiErrorRegular: return "\u{f8fe}"
        case .wifiLight: return "\u{f8ff}"
        case .wifiRegular: return "\u{f900}"
        case .windowCornerScrubBold: return "\u{f901}"
        case .windowCornerScrubLight: return "\u{f902}"
        case .windowCornerScrubRegular: return "\u{f903}"
        case .windowVerticalScrubBold: return "\u{f904}"
        case .windowVerticalScrubLight: return "\u{f905}"
        case .windowVerticalScrubRegular: return "\u{f906}"
        case .workphoneBold: return "\u{f907}"
        case .workphoneLight: return "\u{f908}"
        case .workphoneRegular: return "\u{f909}"
        case .zoomInBold: return "\u{f90a}"
        case .zoomInLight: return "\u{f90b}"
        case .zoomInRegular: return "\u{f90c}"
        case .zoomOutBold: return "\u{f90d}"
        case .zoomOutLight: return "\u{f90e}"
        case .zoomOutRegular: return "\u{f90f}"
