...
class SpaceListDemoVC: UTBaseViewController {
    ...
    var tableMenu: NSMenu = NSMenu(title: "SpaceListMenu")
    ...
    private func startCallTimer() {
        ...
        if callDurationTimer == nil {
            callDurationTimer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(SpaceListDemoVC.updateCallTimer), userInfo: nil, repeats: true)
        }
...
extension SpaceListDemoVC : UTTestSpaceCallTableCellViewDelegate {
...
extension SpaceListDemoVC : NSTableViewDataSource {
...
extension SpaceListDemoVC : NSTableViewDelegate {
...
extension SpaceListDemoVC : UTTableViewDelegate {
...
extension SpaceListDemoVC : NSMenuDelegate {
    func menuWillOpen(_ menu: NSMenu) {
        if menu == tableMenu {
            if let item = dataSource.getItemAtIndex(tableView.clickedRow) {
                
                item.buildMenu(menu: menu, sel: #selector(tableMenuItemAction))
            }
        }
    }
