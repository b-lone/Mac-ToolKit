...
private func SPARK_LOG(_ msg: String?, lineNumber: Int32 = #line, fileName: String = #file, fnName: String = #function) {
...
public func SPARK_LOG_DEBUG(_ msg: String?, lineNumber: Int32 = #line, fileName: String = #file, fnName: String = #function) {
    SPARK_LOG(msg, lineNumber: lineNumber, fileName: fileName, fnName: fnName)
}
...
public func SPARK_LOG_INFO(_ msg: String?, lineNumber: Int32 = #line, fileName: String = #file, fnName: String = #function) {
    SPARK_LOG(msg, lineNumber: lineNumber, fileName: fileName, fnName: fnName)
}
